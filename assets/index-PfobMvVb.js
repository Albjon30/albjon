...
`].filter(gr).join(`
`)),o=Fa(o),o=_o(o,t),o=vo(o,t),s=Fa(s),s=_o(s,t),s=vo(s,t),o=xo(o),s=xo(s),t.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+h);const b=E+d+o,T=E+h+s,B=mo(n,n.VERTEX_SHADER,b),A=mo(n,n.FRAGMENT_SHADER,T);n.attachShader(x,B),n.attachShader(x,A),t.index0AttributeName!==void 0?n.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&n.bindAttribLocation(x,0,"position"),n.linkProgram(x);function R(C){if(r.debug.checkShaderErrors){const H=n.getProgramInfoLog(x).trim(),z=n.getShaderInfoLog(B).trim(),X=n.getShaderInfoLog(A).trim();let Z=!0,W=!0;if(n.getProgramParameter(x,n.LINK_STATUS)===!1)if(Z=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(n,x,B,A);else{const j=go(n,B,"vertex"),V=go(n,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+n.getError()+" - VALIDATE_STATUS "+n.getProgramParameter(x,n.VALIDATE_STATUS)+`
