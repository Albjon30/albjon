...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`,Pe={alphahash_fragment:hc,alphahash_pars_fragment:uc,alphamap_fragment:dc,alphamap_pars_fragment:pc,alphatest_fragment:fc,alphatest_pars_fragment:mc,aomap_fragment:gc,aomap_pars_fragment:_c,batching_pars_vertex:vc,batching_vertex:xc,begin_vertex:Mc,beginnormal_vertex:Sc,bsdfs:yc,iridescence_fragment:Ec,bumpmap_pars_fragment:Tc,clipping_planes_fragment:bc,clipping_planes_pars_fragment:Ac,clipping_planes_pars_vertex:wc,clipping_planes_vertex:Rc,color_fragment:Cc,color_pars_fragment:Pc,color_pars_vertex:Uc,color_vertex:Lc,common:Ic,cube_uv_reflection_fragment:Dc,defaultnormal_vertex:Nc,displacementmap_pars_vertex:Oc,displacementmap_vertex:Fc,emissivemap_fragment:Bc,emissivemap_pars_fragment:zc,colorspace_fragment:Hc,colorspace_pars_fragment:Vc,envmap_fragment:kc,envmap_common_pars_fragment:Gc,envmap_pars_fragment:Wc,envmap_pars_vertex:Xc,envmap_physical_pars_fragment:ih,envmap_vertex:jc,fog_vertex:qc,fog_pars_vertex:Yc,fog_fragment:Kc,fog_pars_fragment:Zc,gradientmap_pars_fragment:Jc,lightmap_pars_fragment:$c,lights_lambert_fragment:Qc,lights_lambert_pars_fragment:eh,lights_pars_begin:th,lights_toon_fragment:rh,lights_toon_pars_fragment:nh,lights_phong_fragment:ah,lights_phong_pars_fragment:sh,lights_physical_fragment:oh,lights_physical_pars_fragment:lh,lights_fragment_begin:ch,lights_fragment_maps:hh,lights_fragment_end:uh,logdepthbuf_fragment:dh,logdepthbuf_pars_fragment:ph,logdepthbuf_pars_vertex:fh,logdepthbuf_vertex:mh,map_fragment:gh,map_pars_fragment:_h,map_particle_fragment:vh,map_particle_pars_fragment:xh,metalnessmap_fragment:Mh,metalnessmap_pars_fragment:Sh,morphinstance_vertex:yh,morphcolor_vertex:Eh,morphnormal_vertex:Th,morphtarget_pars_vertex:bh,morphtarget_vertex:Ah,normal_fragment_begin:wh,normal_fragment_maps:Rh,normal_pars_fragment:Ch,normal_pars_vertex:Ph,normal_vertex:Uh,normalmap_pars_fragment:Lh,clearcoat_normal_fragment_begin:Ih,clearcoat_normal_fragment_maps:Dh,clearcoat_pars_fragment:Nh,iridescence_pars_fragment:Oh,opaque_fragment:Fh,packing:Bh,premultiplied_alpha_fragment:zh,project_vertex:Hh,dithering_fragment:Vh,dithering_pars_fragment:kh,roughnessmap_fragment:Gh,roughnessmap_pars_fragment:Wh,shadowmap_pars_fragment:Xh,shadowmap_pars_vertex:jh,shadowmap_vertex:qh,shadowmask_pars_fragment:Yh,skinbase_vertex:Kh,skinning_pars_vertex:Zh,skinning_vertex:Jh,skinnormal_vertex:$h,specularmap_fragment:Qh,specularmap_pars_fragment:eu,tonemapping_fragment:tu,tonemapping_pars_fragment:iu,transmission_fragment:ru,transmission_pars_fragment:nu,uv_pars_fragment:au,uv_pars_vertex:su,uv_vertex:ou,worldpos_vertex:lu,background_vert:cu,background_frag:hu,backgroundCube_vert:uu,backgroundCube_frag:du,cube_vert:pu,cube_frag:fu,depth_vert:mu,depth_frag:gu,distanceRGBA_vert:_u,distanceRGBA_frag:vu,equirect_vert:xu,equirect_frag:Mu,linedashed_vert:Su,linedashed_frag:yu,meshbasic_vert:Eu,meshbasic_frag:Tu,meshlambert_vert:bu,meshlambert_frag:Au,meshmatcap_vert:wu,meshmatcap_frag:Ru,meshnormal_vert:Cu,meshnormal_frag:Pu,meshphong_vert:Uu,meshphong_frag:Lu,meshphysical_vert:Iu,meshphysical_frag:Du,meshtoon_vert:Nu,meshtoon_frag:Ou,points_vert:Fu,points_frag:Bu,shadow_vert:zu,shadow_frag:Hu,sprite_vert:Vu,sprite_frag:ku},ne={common:{diffuse:{value:new De(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new Ue},alphaMap:{value:null},alphaMapTransform:{value:new Ue},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new Ue}},envmap:{envMap:{value:null},envMapRotation:{value:new Ue},flipEnvMap:{value:-1},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new Ue}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new Ue}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new Ue},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new Ue},normalScale:{value:new Ne(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new Ue},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new Ue}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new Ue}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new Ue}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new De(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMap:{value:[]},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotShadowMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMap:{value:[]},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null}},points:{diffuse:{value:new De(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new Ue},alphaTest:{value:0},uvTransform:{value:new Ue}},sprite:{diffuse:{value:new De(16777215)},opacity:{value:1},center:{value:new Ne(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new Ue},alphaMap:{value:null},alphaMapTransform:{value:new Ue},alphaTest:{value:0}}},Ot={basic:{uniforms:ft([ne.common,ne.specularmap,ne.envmap,ne.aomap,ne.lightmap,ne.fog]),vertexShader:Pe.meshbasic_vert,fragmentShader:Pe.meshbasic_frag},lambert:{uniforms:ft([ne.common,ne.specularmap,ne.envmap,ne.aomap,ne.lightmap,ne.emissivemap,ne.bumpmap,ne.normalmap,ne.displacementmap,ne.fog,ne.lights,{emissive:{value:new De(0)}}]),vertexShader:Pe.meshlambert_vert,fragmentShader:Pe.meshlambert_frag},phong:{uniforms:ft([ne.common,ne.specularmap,ne.envmap,ne.aomap,ne.lightmap,ne.emissivemap,ne.bumpmap,ne.normalmap,ne.displacementmap,ne.fog,ne.lights,{emissive:{value:new De(0)},specular:{value:new De(1118481)},shininess:{value:30}}]),vertexShader:Pe.meshphong_vert,fragmentShader:Pe.meshphong_frag},standard:{uniforms:ft([ne.common,ne.envmap,ne.aomap,ne.lightmap,ne.emissivemap,ne.bumpmap,ne.normalmap,ne.displacementmap,ne.roughnessmap,ne.metalnessmap,ne.fog,ne.lights,{emissive:{value:new De(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:Pe.meshphysical_vert,fragmentShader:Pe.meshphysical_frag},toon:{uniforms:ft([ne.common,ne.aomap,ne.lightmap,ne.emissivemap,ne.bumpmap,ne.normalmap,ne.displacementmap,ne.gradientmap,ne.fog,ne.lights,{emissive:{value:new De(0)}}]),vertexShader:Pe.meshtoon_vert,fragmentShader:Pe.meshtoon_frag},matcap:{uniforms:ft([ne.common,ne.bumpmap,ne.normalmap,ne.displacementmap,ne.fog,{matcap:{value:null}}]),vertexShader:Pe.meshmatcap_vert,fragmentShader:Pe.meshmatcap_frag},points:{uniforms:ft([ne.points,ne.fog]),vertexShader:Pe.points_vert,fragmentShader:Pe.points_frag},dashed:{uniforms:ft([ne.common,ne.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:Pe.linedashed_vert,fragmentShader:Pe.linedashed_frag},depth:{uniforms:ft([ne.common,ne.displacementmap]),vertexShader:Pe.depth_vert,fragmentShader:Pe.depth_frag},normal:{uniforms:ft([ne.common,ne.bumpmap,ne.normalmap,ne.displacementmap,{opacity:{value:1}}]),vertexShader:Pe.meshnormal_vert,fragmentShader:Pe.meshnormal_frag},sprite:{uniforms:ft([ne.sprite,ne.fog]),vertexShader:Pe.sprite_vert,fragmentShader:Pe.sprite_frag},background:{uniforms:{uvTransform:{value:new Ue},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:Pe.background_vert,fragmentShader:Pe.background_frag},backgroundCube:{uniforms:{envMap:{value:null},flipEnvMap:{value:-1},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new Ue}},vertexShader:Pe.backgroundCube_vert,fragmentShader:Pe.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:Pe.cube_vert,fragmentShader:Pe.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:Pe.equirect_vert,fragmentShader:Pe.equirect_frag},distanceRGBA:{uniforms:ft([ne.common,ne.displacementmap,{referencePosition:{value:new I},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:Pe.distanceRGBA_vert,fragmentShader:Pe.distanceRGBA_frag},shadow:{uniforms:ft([ne.lights,ne.fog,{color:{value:new De(0)},opacity:{value:1}}]),vertexShader:Pe.shadow_vert,fragmentShader:Pe.shadow_frag}};Ot.physical={uniforms:ft([Ot.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new Ue},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new Ue},clearcoatNormalScale:{value:new Ne(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new Ue},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new Ue},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new Ue},sheen:{value:0},sheenColor:{value:new De(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new Ue},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new Ue},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new Ue},transmissionSamplerSize:{value:new Ne},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new Ue},attenuationDistance:{value:0},attenuationColor:{value:new De(0)},specularColor:{value:new De(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new Ue},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new Ue},anisotropyVector:{value:new Ne},anisotropyMap:{value:null},anisotropyMapTransform:{value:new Ue}}]),vertexShader:Pe.meshphysical_vert,fragmentShader:Pe.meshphysical_frag};const rn={r:0,b:0,g:0},yi=new Ft,Gu=new Ze;function Wu(r,e,t,i,n,a,o){const s=new De(0);let l=a===!0?0:1,c,u,f=null,p=0,m=null;function v(T){let y=T.isScene===!0?T.background:null;return y&&y.isTexture&&(y=(T.backgroundBlurriness>0?t:e).get(y)),y}function x(T){let y=!1;const b=v(T);b===null?h(s,l):b&&b.isColor&&(h(b,1),y=!0);const B=r.xr.getEnvironmentBlendMode();B==="additive"?i.buffers.color.setClear(0,0,0,1,o):B==="alpha-blend"&&i.buffers.color.setClear(0,0,0,0,o),(r.autoClear||y)&&(i.buffers.depth.setTest(!0),i.buffers.depth.setMask(!0),i.buffers.color.setMask(!0),r.clear(r.autoClearColor,r.autoClearDepth,r.autoClearStencil))}function d(T,y){const b=v(y);b&&(b.isCubeTexture||b.mapping===br)?(u===void 0&&(u=new bt(new Mr(1,1,1),new oi({name:"BackgroundCubeMaterial",uniforms:Zi(Ot.backgroundCube.uniforms),vertexShader:Ot.backgroundCube.vertexShader,fragmentShader:Ot.backgroundCube.fragmentShader,side:mt,depthTest:!1,depthWrite:!1,fog:!1})),u.geometry.deleteAttribute("normal"),u.geometry.deleteAttribute("uv"),u.onBeforeRender=function(B,w,R){this.matrixWorld.copyPosition(R.matrixWorld)},Object.defineProperty(u.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),n.update(u)),yi.copy(y.backgroundRotation),yi.x*=-1,yi.y*=-1,yi.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(yi.y*=-1,yi.z*=-1),u.material.uniforms.envMap.value=b,u.material.uniforms.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,u.material.uniforms.backgroundBlurriness.value=y.backgroundBlurriness,u.material.uniforms.backgroundIntensity.value=y.backgroundIntensity,u.material.uniforms.backgroundRotation.value.setFromMatrix4(Gu.makeRotationFromEuler(yi)),u.material.toneMapped=ze.getTransfer(b.colorSpace)!==Xe,(f!==b||p!==b.version||m!==r.toneMapping)&&(u.material.needsUpdate=!0,f=b,p=b.version,m=r.toneMapping),u.layers.enableAll(),T.unshift(u,u.geometry,u.material,0,0,null)):b&&b.isTexture&&(c===void 0&&(c=new bt(new fn(2,2),new oi({name:"BackgroundMaterial",uniforms:Zi(Ot.background.uniforms),vertexShader:Ot.background.vertexShader,fragmentShader:Ot.background.fragmentShader,side:Jt,depthTest:!1,depthWrite:!1,fog:!1})),c.geometry.deleteAttribute("normal"),Object.defineProperty(c.material,"map",{get:function(){return this.uniforms.t2D.value}}),n.update(c)),c.material.uniforms.t2D.value=b,c.material.uniforms.backgroundIntensity.value=y.backgroundIntensity,c.material.toneMapped=ze.getTransfer(b.colorSpace)!==Xe,b.matrixAutoUpdate===!0&&b.updateMatrix(),c.material.uniforms.uvTransform.value.copy(b.matrix),(f!==b||p!==b.version||m!==r.toneMapping)&&(c.material.needsUpdate=!0,f=b,p=b.version,m=r.toneMapping),c.layers.enableAll(),T.unshift(c,c.geometry,c.material,0,0,null))}function h(T,y){T.getRGB(rn,ks(r)),i.buffers.color.setClear(rn.r,rn.g,rn.b,y,o)}return{getClearColor:function(){return s},setClearColor:function(T,y=1){s.set(T),l=y,h(s,l)},getClearAlpha:function(){return l},setClearAlpha:function(T){l=T,h(s,l)},render:x,addToRenderList:d}}function Xu(r,e){const t=r.getParameter(r.MAX_VERTEX_ATTRIBS),i={},n=p(null);let a=n,o=!1;function s(M,C,H,z,j){let Z=!1;const W=f(z,H,C);a!==W&&(a=W,c(a.object)),Z=m(M,z,H,j),Z&&v(M,z,H,j),j!==null&&e.update(j,r.ELEMENT_ARRAY_BUFFER),(Z||o)&&(o=!1,b(M,C,H,z),j!==null&&r.bindBuffer(r.ELEMENT_ARRAY_BUFFER,e.get(j).buffer))}function l(){return r.createVertexArray()}function c(M){return r.bindVertexArray(M)}function u(M){return r.deleteVertexArray(M)}function f(M,C,H){const z=H.wireframe===!0;let j=i[M.id];j===void 0&&(j={},i[M.id]=j);let Z=j[C.id];Z===void 0&&(Z={},j[C.id]=Z);let W=Z[z];return W===void 0&&(W=p(l()),Z[z]=W),W}function p(M){const C=[],H=[],z=[];for(let j=0;j<t;j++)C[j]=0,H[j]=0,z[j]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:C,enabledAttributes:H,attributeDivisors:z,object:M,attributes:{},index:null}}function m(M,C,H,z){const j=a.attributes,Z=C.attributes;let W=0;const X=H.getAttributes();for(const V in X)if(X[V].location>=0){const re=j[V];let fe=Z[V];if(fe===void 0&&(V==="instanceMatrix"&&M.instanceMatrix&&(fe=M.instanceMatrix),V==="instanceColor"&&M.instanceColor&&(fe=M.instanceColor)),re===void 0||re.attribute!==fe||fe&&re.data!==fe.data)return!0;W++}return a.attributesNum!==W||a.index!==z}function v(M,C,H,z){const j={},Z=C.attributes;let W=0;const X=H.getAttributes();for(const V in X)if(X[V].location>=0){let re=Z[V];re===void 0&&(V==="instanceMatrix"&&M.instanceMatrix&&(re=M.instanceMatrix),V==="instanceColor"&&M.instanceColor&&(re=M.instanceColor));const fe={};fe.attribute=re,re&&re.data&&(fe.data=re.data),j[V]=fe,W++}a.attributes=j,a.attributesNum=W,a.index=z}function x(){const M=a.newAttributes;for(let C=0,H=M.length;C<H;C++)M[C]=0}function d(M){h(M,0)}function h(M,C){const H=a.newAttributes,z=a.enabledAttributes,j=a.attributeDivisors;H[M]=1,z[M]===0&&(r.enableVertexAttribArray(M),z[M]=1),j[M]!==C&&(r.vertexAttribDivisor(M,C),j[M]=C)}function T(){const M=a.newAttributes,C=a.enabledAttributes;for(let H=0,z=C.length;H<z;H++)C[H]!==M[H]&&(r.disableVertexAttribArray(H),C[H]=0)}function y(M,C,H,z,j,Z,W){W===!0?r.vertexAttribIPointer(M,C,H,j,Z):r.vertexAttribPointer(M,C,H,z,j,Z)}function b(M,C,H,z){x();const j=z.attributes,Z=H.getAttributes(),W=C.defaultAttributeValues;for(const X in Z){const V=Z[X];if(V.location>=0){let re=j[X];if(re===void 0&&(X==="instanceMatrix"&&M.instanceMatrix&&(re=M.instanceMatrix),X==="instanceColor"&&M.instanceColor&&(re=M.instanceColor)),re!==void 0){const fe=re.normalized,Se=re.itemSize,Oe=e.get(re);if(Oe===void 0)continue;const ke=Oe.buffer,G=Oe.type,Q=Oe.bytesPerElement,de=G===r.INT||G===r.UNSIGNED_INT||re.gpuType===wn;if(re.isInterleavedBufferAttribute){const oe=re.data,ye=oe.stride,we=re.offset;if(oe.isInstancedInterleavedBuffer){for(let Ie=0;Ie<V.locationSize;Ie++)h(V.location+Ie,oe.meshPerAttribute);M.isInstancedMesh!==!0&&z._maxInstanceCount===void 0&&(z._maxInstanceCount=oe.meshPerAttribute*oe.count)}else for(let Ie=0;Ie<V.locationSize;Ie++)d(V.location+Ie);r.bindBuffer(r.ARRAY_BUFFER,ke);for(let Ie=0;Ie<V.locationSize;Ie++)y(V.location+Ie,Se/V.locationSize,G,fe,ye*Q,(we+Se/V.locationSize*Ie)*Q,de)}else{if(re.isInstancedBufferAttribute){for(let oe=0;oe<V.locationSize;oe++)h(V.location+oe,re.meshPerAttribute);M.isInstancedMesh!==!0&&z._maxInstanceCount===void 0&&(z._maxInstanceCount=re.meshPerAttribute*re.count)}else for(let oe=0;oe<V.locationSize;oe++)d(V.location+oe);r.bindBuffer(r.ARRAY_BUFFER,ke);for(let oe=0;oe<V.locationSize;oe++)y(V.location+oe,Se/V.locationSize,G,fe,Se*Q,Se/V.locationSize*oe*Q,de)}}else if(W!==void 0){const fe=W[X];if(fe!==void 0)switch(fe.length){case 2:r.vertexAttrib2fv(V.location,fe);break;case 3:r.vertexAttrib3fv(V.location,fe);break;case 4:r.vertexAttrib4fv(V.location,fe);break;default:r.vertexAttrib1fv(V.location,fe)}}}}T()}function B(){N();for(const M in i){const C=i[M];for(const H in C){const z=C[H];for(const j in z)u(z[j].object),delete z[j];delete C[H]}delete i[M]}}function w(M){if(i[M.id]===void 0)return;const C=i[M.id];for(const H in C){const z=C[H];for(const j in z)u(z[j].object),delete z[j];delete C[H]}delete i[M.id]}function R(M){for(const C in i){const H=i[C];if(H[M.id]===void 0)continue;const z=H[M.id];for(const j in z)u(z[j].object),delete z[j];delete H[M.id]}}function N(){S(),o=!0,a!==n&&(a=n,c(a.object))}function S(){n.geometry=null,n.program=null,n.wireframe=!1}return{setup:s,reset:N,resetDefaultState:S,dispose:B,releaseStatesOfGeometry:w,releaseStatesOfProgram:R,initAttributes:x,enableAttribute:d,disableUnusedAttributes:T}}function ju(r,e,t){let i;function n(c){i=c}function a(c,u){r.drawArrays(i,c,u),t.update(u,i,1)}function o(c,u,f){f!==0&&(r.drawArraysInstanced(i,c,u,f),t.update(u,i,f))}function s(c,u,f){if(f===0)return;e.get("WEBGL_multi_draw").multiDrawArraysWEBGL(i,c,0,u,0,f);let p=0;for(let m=0;m<f;m++)p+=u[m];t.update(p,i,1)}function l(c,u,f,p){if(f===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let v=0;v<c.length;v++)o(c[v],u[v],p[v]);else{m.multiDrawArraysInstancedWEBGL(i,c,0,u,0,p,0,f);let v=0;for(let x=0;x<f;x++)v+=u[x];for(let x=0;x<p.length;x++)t.update(v,i,p[x])}}this.setMode=n,this.render=a,this.renderInstances=o,this.renderMultiDraw=s,this.renderMultiDrawInstances=l}function qu(r,e,t,i){let n;function a(){if(n!==void 0)return n;if(e.has("EXT_texture_filter_anisotropic")===!0){const w=e.get("EXT_texture_filter_anisotropic");n=r.getParameter(w.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else n=0;return n}function o(w){return!(w!==Rt&&i.convert(w)!==r.getParameter(r.IMPLEMENTATION_COLOR_READ_FORMAT))}function s(w){const R=w===nr&&(e.has("EXT_color_buffer_half_float")||e.has("EXT_color_buffer_float"));return!(w!==kt&&i.convert(w)!==r.getParameter(r.IMPLEMENTATION_COLOR_READ_TYPE)&&w!==Gt&&!R)}function l(w){if(w==="highp"){if(r.getShaderPrecisionFormat(r.VERTEX_SHADER,r.HIGH_FLOAT).precision>0&&r.getShaderPrecisionFormat(r.FRAGMENT_SHADER,r.HIGH_FLOAT).precision>0)return"highp";w="mediump"}return w==="mediump"&&r.getShaderPrecisionFormat(r.VERTEX_SHADER,r.MEDIUM_FLOAT).precision>0&&r.getShaderPrecisionFormat(r.FRAGMENT_SHADER,r.MEDIUM_FLOAT).precision>0?"mediump":"lowp"}let c=t.precision!==void 0?t.precision:"highp";const u=l(c);u!==c&&(console.warn("THREE.WebGLRenderer:",c,"not supported, using",u,"instead."),c=u);const f=t.logarithmicDepthBuffer===!0,p=r.getParameter(r.MAX_TEXTURE_IMAGE_UNITS),m=r.getParameter(r.MAX_VERTEX_TEXTURE_IMAGE_UNITS),v=r.getParameter(r.MAX_TEXTURE_SIZE),x=r.getParameter(r.MAX_CUBE_MAP_TEXTURE_SIZE),d=r.getParameter(r.MAX_VERTEX_ATTRIBS),h=r.getParameter(r.MAX_VERTEX_UNIFORM_VECTORS),T=r.getParameter(r.MAX_VARYING_VECTORS),y=r.getParameter(r.MAX_FRAGMENT_UNIFORM_VECTORS),b=m>0,B=r.getParameter(r.MAX_SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:a,getMaxPrecision:l,textureFormatReadable:o,textureTypeReadable:s,precision:c,logarithmicDepthBuffer:f,maxTextures:p,maxVertexTextures:m,maxTextureSize:v,maxCubemapSize:x,maxAttributes:d,maxVertexUniforms:h,maxVaryings:T,maxFragmentUniforms:y,vertexTextures:b,maxSamples:B}}function Yu(r){const e=this;let t=null,i=0,n=!1,a=!1;const o=new Mi,s=new Ue,l={value:null,needsUpdate:!1};this.uniform=l,this.numPlanes=0,this.numIntersection=0,this.init=function(f,p){const m=f.length!==0||p||i!==0||n;return n=p,i=f.length,m},this.beginShadows=function(){a=!0,u(null)},this.endShadows=function(){a=!1},this.setGlobalState=function(f,p){t=u(f,p,0)},this.setState=function(f,p,m){const v=f.clippingPlanes,x=f.clipIntersection,d=f.clipShadows,h=r.get(f);if(!n||v===null||v.length===0||a&&!d)a?u(null):c();else{const T=a?0:i,y=T*4;let b=h.clippingState||null;l.value=b,b=u(v,p,y,m);for(let B=0;B!==y;++B)b[B]=t[B];h.clippingState=b,this.numIntersection=x?this.numPlanes:0,this.numPlanes+=T}};function c(){l.value!==t&&(l.value=t,l.needsUpdate=i>0),e.numPlanes=i,e.numIntersection=0}function u(f,p,m,v){const x=f!==null?f.length:0;let d=null;if(x!==0){if(d=l.value,v!==!0||d===null){const h=m+x*4,T=p.matrixWorldInverse;s.getNormalMatrix(T),(d===null||d.length<h)&&(d=new Float32Array(h));for(let y=0,b=m;y!==x;++y,b+=4)o.copy(f[y]).applyMatrix4(T,s),o.normal.toArray(d,b),d[b+3]=o.constant}l.value=d,l.needsUpdate=!0}return e.numPlanes=x,e.numIntersection=0,d}}function Ku(r){let e=new WeakMap;function t(o,s){return s===yn?o.mapping=Ci:s===En&&(o.mapping=Pi),o}function i(o){if(o&&o.isTexture){const s=o.mapping;if(s===yn||s===En)if(e.has(o)){const l=e.get(o).texture;return t(l,o.mapping)}else{const l=o.image;if(l&&l.height>0){const c=new sc(l.height);return c.fromEquirectangularTexture(r,o),e.set(o,c),o.addEventListener("dispose",n),t(c.texture,o.mapping)}else return null}}return o}function n(o){const s=o.target;s.removeEventListener("dispose",n);const l=e.get(s);l!==void 0&&(e.delete(s),l.dispose())}function a(){e=new WeakMap}return{get:i,dispose:a}}class Ys extends Gs{constructor(e=-1,t=1,i=1,n=-1,a=.1,o=2e3){super(),this.isOrthographicCamera=!0,this.type="OrthographicCamera",this.zoom=1,this.view=null,this.left=e,this.right=t,this.top=i,this.bottom=n,this.near=a,this.far=o,this.updateProjectionMatrix()}copy(e,t){return super.copy(e,t),this.left=e.left,this.right=e.right,this.top=e.top,this.bottom=e.bottom,this.near=e.near,this.far=e.far,this.zoom=e.zoom,this.view=e.view===null?null:Object.assign({},e.view),this}setViewOffset(e,t,i,n,a,o){this.view===null&&(this.view={enabled:!0,fullWidth:1,fullHeight:1,offsetX:0,offsetY:0,width:1,height:1}),this.view.enabled=!0,this.view.fullWidth=e,this.view.fullHeight=t,this.view.offsetX=i,this.view.offsetY=n,this.view.width=a,this.view.height=o,this.updateProjectionMatrix()}clearViewOffset(){this.view!==null&&(this.view.enabled=!1),this.updateProjectionMatrix()}updateProjectionMatrix(){const e=(this.right-this.left)/(2*this.zoom),t=(this.top-this.bottom)/(2*this.zoom),i=(this.right+this.left)/2,n=(this.top+this.bottom)/2;let a=i-e,o=i+e,s=n+t,l=n-t;if(this.view!==null&&this.view.enabled){const c=(this.right-this.left)/this.view.fullWidth/this.zoom,u=(this.top-this.bottom)/this.view.fullHeight/this.zoom;a+=c*this.view.offsetX,o=a+c*this.view.width,s-=u*this.view.offsetY,l=s-u*this.view.height}this.projectionMatrix.makeOrthographic(a,o,s,l,this.near,this.far,this.coordinateSystem),this.projectionMatrixInverse.copy(this.projectionMatrix).invert()}toJSON(e){const t=super.toJSON(e);return t.object.zoom=this.zoom,t.object.left=this.left,t.object.right=this.right,t.object.top=this.top,t.object.bottom=this.bottom,t.object.near=this.near,t.object.far=this.far,this.view!==null&&(t.object.view=Object.assign({},this.view)),t}}const Qi=4,Ks=[.125,.215,.35,.446,.526,.582],Ei=20,Pa=new Ys,Zs=new De;let Ua=null,La=0,Ia=0,Da=!1;const Ti=(1+Math.sqrt(5))/2,er=1/Ti,Js=[new I(-Ti,er,0),new I(Ti,er,0),new I(-er,0,Ti),new I(er,0,Ti),new I(0,Ti,-er),new I(0,Ti,er),new I(-1,1,-1),new I(1,1,-1),new I(-1,1,1),new I(1,1,1)];class $s{constructor(e){this._renderer=e,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._lodPlanes=[],this._sizeLods=[],this._sigmas=[],this._blurMaterial=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._compileMaterial(this._blurMaterial)}fromScene(e,t=0,i=.1,n=100){Ua=this._renderer.getRenderTarget(),La=this._renderer.getActiveCubeFace(),Ia=this._renderer.getActiveMipmapLevel(),Da=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(256);const a=this._allocateTargets();return a.depthBuffer=!0,this._sceneToCubeUV(e,i,n,a),t>0&&this._blur(a,0,0,t),this._applyPMREM(a),this._cleanup(a),a}fromEquirectangular(e,t=null){return this._fromTexture(e,t)}fromCubemap(e,t=null){return this._fromTexture(e,t)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=to(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=eo(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose()}_setSize(e){this._lodMax=Math.floor(Math.log2(e)),this._cubeSize=Math.pow(2,this._lodMax)}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let e=0;e<this._lodPlanes.length;e++)this._lodPlanes[e].dispose()}_cleanup(e){this._renderer.setRenderTarget(Ua,La,Ia),this._renderer.xr.enabled=Da,e.scissorTest=!1,nn(e,0,0,e.width,e.height)}_fromTexture(e,t){e.mapping===Ci||e.mapping===Pi?this._setSize(e.image.length===0?16:e.image[0].width||e.image[0].image.width):this._setSize(e.image.width/4),Ua=this._renderer.getRenderTarget(),La=this._renderer.getActiveCubeFace(),Ia=this._renderer.getActiveMipmapLevel(),Da=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;const i=t||this._allocateTargets();return this._textureToCubeUV(e,i),this._applyPMREM(i),this._cleanup(i),i}_allocateTargets(){const e=3*Math.max(this._cubeSize,112),t=4*this._cubeSize,i={magFilter:wt,minFilter:wt,generateMipmaps:!1,type:nr,format:Rt,colorSpace:ti,depthBuffer:!1},n=Qs(e,t,i);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==e||this._pingPongRenderTarget.height!==t){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=Qs(e,t,i);const{_lodMax:a}=this;({sizeLods:this._sizeLods,lodPlanes:this._lodPlanes,sigmas:this._sigmas}=Zu(a)),this._blurMaterial=Ju(a,e,t)}return n}_compileMaterial(e){const t=new bt(this._lodPlanes[0],e);this._renderer.compile(t,Pa)}_sceneToCubeUV(e,t,i,n){const a=new St(90,1,t,i),o=[1,-1,1,1,1,1],s=[1,1,1,-1,-1,-1],l=this._renderer,c=l.autoClear,u=l.toneMapping;l.getClearColor(Zs),l.toneMapping=Qt,l.autoClear=!1;const f=new ba({name:"PMREM.Background",side:mt,depthWrite:!1,depthTest:!1}),p=new bt(new Mr,f);let m=!1;const v=e.background;v?v.isColor&&(f.color.copy(v),e.background=null,m=!0):(f.color.copy(Zs),m=!0);for(let x=0;x<6;x++){const d=x%3;d===0?(a.up.set(0,o[x],0),a.lookAt(s[x],0,0)):d===1?(a.up.set(0,0,o[x]),a.lookAt(0,s[x],0)):(a.up.set(0,o[x],0),a.lookAt(0,0,s[x]));const h=this._cubeSize;nn(n,d*h,x>2?h:0,h,h),l.setRenderTarget(n),m&&l.render(p,a),l.render(e,a)}p.geometry.dispose(),p.material.dispose(),l.toneMapping=u,l.autoClear=c,e.background=v}_textureToCubeUV(e,t){const i=this._renderer,n=e.mapping===Ci||e.mapping===Pi;n?(this._cubemapMaterial===null&&(this._cubemapMaterial=to()),this._cubemapMaterial.uniforms.flipEnvMap.value=e.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=eo());const a=n?this._cubemapMaterial:this._equirectMaterial,o=new bt(this._lodPlanes[0],a),s=a.uniforms;s.envMap.value=e;const l=this._cubeSize;nn(t,0,0,3*l,2*l),i.setRenderTarget(t),i.render(o,Pa)}_applyPMREM(e){const t=this._renderer,i=t.autoClear;t.autoClear=!1;const n=this._lodPlanes.length;for(let a=1;a<n;a++){const o=Math.sqrt(this._sigmas[a]*this._sigmas[a]-this._sigmas[a-1]*this._sigmas[a-1]),s=Js[(n-a-1)%Js.length];this._blur(e,a-1,a,o,s)}t.autoClear=i}_blur(e,t,i,n,a){const o=this._pingPongRenderTarget;this._halfBlur(e,o,t,i,n,"latitudinal",a),this._halfBlur(o,e,i,i,n,"longitudinal",a)}_halfBlur(e,t,i,n,a,o,s){const l=this._renderer,c=this._blurMaterial;o!=="latitudinal"&&o!=="longitudinal"&&console.error("blur direction must be either latitudinal or longitudinal!");const u=3,f=new bt(this._lodPlanes[n],c),p=c.uniforms,m=this._sizeLods[i]-1,v=isFinite(a)?Math.PI/(2*m):2*Math.PI/(2*Ei-1),x=a/v,d=isFinite(a)?1+Math.floor(u*x):Ei;d>Ei&&console.warn(`sigmaRadians, ${a}, is too large and will clip, as it requested ${d} samples when the maximum is set to ${Ei}`);const h=[];let T=0;for(let R=0;R<Ei;++R){const N=R/x,S=Math.exp(-N*N/2);h.push(S),R===0?T+=S:R<d&&(T+=2*S)}for(let R=0;R<h.length;R++)h[R]=h[R]/T;p.envMap.value=e.texture,p.samples.value=d,p.weights.value=h,p.latitudinal.value=o==="latitudinal",s&&(p.poleAxis.value=s);const{_lodMax:y}=this;p.dTheta.value=v,p.mipInt.value=y-i;const b=this._sizeLods[n],B=3*b*(n>y-Qi?n-y+Qi:0),w=4*(this._cubeSize-b);nn(t,B,w,3*b,2*b),l.setRenderTarget(t),l.render(f,Pa)}}function Zu(r){const e=[],t=[],i=[];let n=r;const a=r-Qi+1+Ks.length;for(let o=0;o<a;o++){const s=Math.pow(2,n);t.push(s);let l=1/s;o>r-Qi?l=Ks[o-r+Qi-1]:o===0&&(l=0),i.push(l);const c=1/(s-2),u=-c,f=1+c,p=[u,u,f,u,f,f,u,u,f,f,u,f],m=6,v=6,x=3,d=2,h=1,T=new Float32Array(x*v*m),y=new Float32Array(d*v*m),b=new Float32Array(h*v*m);for(let w=0;w<m;w++){const R=w%3*2/3-1,N=w>2?0:-1,S=[R,N,0,R+2/3,N,0,R+2/3,N+1,0,R,N,0,R+2/3,N+1,0,R,N+1,0];T.set(S,x*v*w),y.set(p,d*v*w);const M=[w,w,w,w,w,w];b.set(M,h*v*w)}const B=new ci;B.setAttribute("position",new Dt(T,x)),B.setAttribute("uv",new Dt(y,d)),B.setAttribute("faceIndex",new Dt(b,h)),e.push(B),n>Qi&&n--}return{lodPlanes:e,sizeLods:t,sigmas:i}}function Qs(r,e,t){const i=new gi(r,e,t);return i.texture.mapping=br,i.texture.name="PMREM.cubeUv",i.scissorTest=!0,i}function nn(r,e,t,i,n){r.viewport.set(e,t,i,n),r.scissor.set(e,t,i,n)}function Ju(r,e,t){const i=new Float32Array(Ei),n=new I(0,1,0);return new oi({name:"SphericalGaussianBlur",defines:{n:Ei,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:n}},vertexShader:Na(),fragmentShader:`
...
`)+`
`+h);const y=T+d+o,b=T+h+s,B=mo(n,n.VERTEX_SHADER,y),w=mo(n,n.FRAGMENT_SHADER,b);n.attachShader(x,B),n.attachShader(x,w),t.index0AttributeName!==void 0?n.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&n.bindAttribLocation(x,0,"position"),n.linkProgram(x);function R(C){if(r.debug.checkShaderErrors){const H=n.getProgramInfoLog(x).trim(),z=n.getShaderInfoLog(B).trim(),j=n.getShaderInfoLog(w).trim();let Z=!0,W=!0;if(n.getProgramParameter(x,n.LINK_STATUS)===!1)if(Z=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(n,x,B,w);else{const X=go(n,B,"vertex"),V=go(n,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+n.getError()+" - VALIDATE_STATUS "+n.getProgramParameter(x,n.VALIDATE_STATUS)+`
...
Program Info Log: `+H+`
`+X+`
`+V)}else H!==""?console.warn("THREE.WebGLProgram: Program Info Log:",H):(z===""||j==="")&&(W=!1);W&&(C.diagnostics={runnable:Z,programLog:H,vertexShader:{log:z,prefix:d},fragmentShader:{log:j,prefix:h}})}n.deleteShader(B),n.deleteShader(w),N=new sn(n,x),S=np(n,x)}let N;this.getUniforms=function(){return N===void 0&&R(this),N};let S;this.getAttributes=function(){return S===void 0&&R(this),S};let M=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return M===!1&&(M=n.getProgramParameter(x,Kd)),M},this.destroy=function(){i.releaseStatesOfProgram(this),n.deleteProgram(x),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Zd++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=B,this.fragmentShader=w,this}let gp=0;class _p{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,n=this._getShaderStage(t),a=this._getShaderStage(i),o=this._getShaderCacheForMaterial(e);return o.has(n)===!1&&(o.add(n),n.usedTimes++),o.has(a)===!1&&(o.add(a),a.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new vp(e),t.set(e,i)),i}}class vp{constructor(e){this.id=gp++,this.code=e,this.usedTimes=0}}function xp(r,e,t,i,n,a,o){const s=new ws,l=new _p,c=new Set,u=[],f=n.logarithmicDepthBuffer,p=n.vertexTextures;let m=n.precision;const v={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(S){return c.add(S),S===0?"uv":`uv${S}`}function d(S,M,C,H,z){const j=H.fog,Z=z.geometry,W=S.isMeshStandardMaterial?H.environment:null,X=(S.isMeshStandardMaterial?t:e).get(S.envMap||W),V=X&&X.mapping===br?X.image.height:null,re=v[S.type];S.precision!==null&&(m=n.getMaxPrecision(S.precision),m!==S.precision&&console.warn("THREE.WebGLProgram.getParameters:",S.precision,"not supported, using",m,"instead."));const fe=Z.morphAttributes.position||Z.morphAttributes.normal||Z.morphAttributes.color,Se=fe!==void 0?fe.length:0;let Oe=0;Z.morphAttributes.position!==void 0&&(Oe=1),Z.morphAttributes.normal!==void 0&&(Oe=2),Z.morphAttributes.color!==void 0&&(Oe=3);let ke,G,Q,de;if(re){const Be=Ot[re];ke=Be.vertexShader,G=Be.fragmentShader}else ke=S.vertexShader,G=S.fragmentShader,l.update(S),Q=l.getVertexShaderID(S),de=l.getFragmentShaderID(S);const oe=r.getRenderTarget(),ye=z.isInstancedMesh===!0,we=z.isBatchedMesh===!0,Ie=!!S.map,Ke=!!S.matcap,A=!!X,$e=!!S.aoMap,He=!!S.lightMap,Ge=!!S.bumpMap,ge=!!S.normalMap,Qe=!!S.displacementMap,be=!!S.emissiveMap,Re=!!S.metalnessMap,E=!!S.roughnessMap,g=S.anisotropy>0,F=S.clearcoat>0,q=S.dispersion>0,J=S.iridescence>0,Y=S.sheen>0,ve=S.transmission>0,ae=g&&!!S.anisotropyMap,ce=F&&!!S.clearcoatMap,Ce=F&&!!S.clearcoatNormalMap,ee=F&&!!S.clearcoatRoughnessMap,he=J&&!!S.iridescenceMap,Fe=J&&!!S.iridescenceThicknessMap,Te=Y&&!!S.sheenColorMap,le=Y&&!!S.sheenRoughnessMap,Ae=!!S.specularMap,Le=!!S.specularColorMap,Ye=!!S.specularIntensityMap,P=ve&&!!S.transmissionMap,te=ve&&!!S.thicknessMap,k=!!S.gradientMap,K=!!S.alphaMap,ie=S.alphaTest>0,_e=!!S.alphaHash,We=!!S.extensions;let et=Qt;S.toneMapped&&(oe===null||oe.isXRRenderTarget===!0)&&(et=r.toneMapping);const lt={shaderID:re,shaderType:S.type,shaderName:S.name,vertexShader:ke,fragmentShader:G,defines:S.defines,customVertexShaderID:Q,customFragmentShaderID:de,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:m,batching:we,batchingColor:we&&z._colorsTexture!==null,instancing:ye,instancingColor:ye&&z.instanceColor!==null,instancingMorph:ye&&z.morphTexture!==null,supportsVertexTextures:p,outputColorSpace:oe===null?r.outputColorSpace:oe.isXRRenderTarget===!0?oe.texture.colorSpace:ti,alphaToCoverage:!!S.alphaToCoverage,map:Ie,matcap:Ke,envMap:A,envMapMode:A&&X.mapping,envMapCubeUVHeight:V,aoMap:$e,lightMap:He,bumpMap:Ge,normalMap:ge,displacementMap:p&&Qe,emissiveMap:be,normalMapObjectSpace:ge&&S.normalMapType===wl,normalMapTangentSpace:ge&&S.normalMapType===ps,metalnessMap:Re,roughnessMap:E,anisotropy:g,anisotropyMap:ae,clearcoat:F,clearcoatMap:ce,clearcoatNormalMap:Ce,clearcoatRoughnessMap:ee,dispersion:q,iridescence:J,iridescenceMap:he,iridescenceThicknessMap:Fe,sheen:Y,sheenColorMap:Te,sheenRoughnessMap:le,specularMap:Ae,specularColorMap:Le,specularIntensityMap:Ye,transmission:ve,transmissionMap:P,thicknessMap:te,gradientMap:k,opaque:S.transparent===!1&&S.blending===Ri&&S.alphaToCoverage===!1,alphaMap:K,alphaTest:ie,alphaHash:_e,combine:S.combine,mapUv:Ie&&x(S.map.channel),aoMapUv:$e&&x(S.aoMap.channel),lightMapUv:He&&x(S.lightMap.channel),bumpMapUv:Ge&&x(S.bumpMap.channel),normalMapUv:ge&&x(S.normalMap.channel),displacementMapUv:Qe&&x(S.displacementMap.channel),emissiveMapUv:be&&x(S.emissiveMap.channel),metalnessMapUv:Re&&x(S.metalnessMap.channel),roughnessMapUv:E&&x(S.roughnessMap.channel),anisotropyMapUv:ae&&x(S.anisotropyMap.channel),clearcoatMapUv:ce&&x(S.clearcoatMap.channel),clearcoatNormalMapUv:Ce&&x(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ee&&x(S.clearcoatRoughnessMap.channel),iridescenceMapUv:he&&x(S.iridescenceMap.channel),iridescenceThicknessMapUv:Fe&&x(S.iridescenceThicknessMap.channel),sheenColorMapUv:Te&&x(S.sheenColorMap.channel),sheenRoughnessMapUv:le&&x(S.sheenRoughnessMap.channel),specularMapUv:Ae&&x(S.specularMap.channel),specularColorMapUv:Le&&x(S.specularColorMap.channel),specularIntensityMapUv:Ye&&x(S.specularIntensityMap.channel),transmissionMapUv:P&&x(S.transmissionMap.channel),thicknessMapUv:te&&x(S.thicknessMap.channel),alphaMapUv:K&&x(S.alphaMap.channel),vertexTangents:!!Z.attributes.tangent&&(ge||g),vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!Z.attributes.color&&Z.attributes.color.itemSize===4,pointsUvs:z.isPoints===!0&&!!Z.attributes.uv&&(Ie||K),fog:!!j,useFog:S.fog===!0,fogExp2:!!j&&j.isFogExp2,flatShading:S.flatShading===!0,sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:f,skinning:z.isSkinnedMesh===!0,morphTargets:Z.morphAttributes.position!==void 0,morphNormals:Z.morphAttributes.normal!==void 0,morphColors:Z.morphAttributes.color!==void 0,morphTargetsCount:Se,morphTextureStride:Oe,numDirLights:M.directional.length,numPointLights:M.point.length,numSpotLights:M.spot.length,numSpotLightMaps:M.spotLightMap.length,numRectAreaLights:M.rectArea.length,numHemiLights:M.hemi.length,numDirLightShadows:M.directionalShadowMap.length,numPointLightShadows:M.pointShadowMap.length,numSpotLightShadows:M.spotShadowMap.length,numSpotLightShadowsWithMaps:M.numSpotLightShadowsWithMaps,numLightProbes:M.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:S.dithering,shadowMapEnabled:r.shadowMap.enabled&&C.length>0,shadowMapType:r.shadowMap.type,toneMapping:et,decodeVideoTexture:Ie&&S.map.isVideoTexture===!0&&ze.getTransfer(S.map.colorSpace)===Xe,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===Vt,flipSided:S.side===mt,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:We&&S.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(We&&S.extensions.multiDraw===!0||we)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return lt.vertexUv1s=c.has(1),lt.vertexUv2s=c.has(2),lt.vertexUv3s=c.has(3),c.clear(),lt}function h(S){const M=[];if(S.shaderID?M.push(S.shaderID):(M.push(S.customVertexShaderID),M.push(S.customFragmentShaderID)),S.defines!==void 0)for(const C in S.defines)M.push(C),M.push(S.defines[C]);return S.isRawShaderMaterial===!1&&(T(M,S),y(M,S),M.push(r.outputColorSpace)),M.push(S.customProgramCacheKey),M.join()}function T(S,M){S.push(M.precision),S.push(M.outputColorSpace),S.push(M.envMapMode),S.push(M.envMapCubeUVHeight),S.push(M.mapUv),S.push(M.alphaMapUv),S.push(M.lightMapUv),S.push(M.aoMapUv),S.push(M.bumpMapUv),S.push(M.normalMapUv),S.push(M.displacementMapUv),S.push(M.emissiveMapUv),S.push(M.metalnessMapUv),S.push(M.roughnessMapUv),S.push(M.anisotropyMapUv),S.push(M.clearcoatMapUv),S.push(M.clearcoatNormalMapUv),S.push(M.clearcoatRoughnessMapUv),S.push(M.iridescenceMapUv),S.push(M.iridescenceThicknessMapUv),S.push(M.sheenColorMapUv),S.push(M.sheenRoughnessMapUv),S.push(M.specularMapUv),S.push(M.specularColorMapUv),S.push(M.specularIntensityMapUv),S.push(M.transmissionMapUv),S.push(M.thicknessMapUv),S.push(M.combine),S.push(M.fogExp2),S.push(M.sizeAttenuation),S.push(M.morphTargetsCount),S.push(M.morphAttributeCount),S.push(M.numDirLights),S.push(M.numPointLights),S.push(M.numSpotLights),S.push(M.numSpotLightMaps),S.push(M.numHemiLights),S.push(M.numRectAreaLights),S.push(M.numDirLightShadows),S.push(M.numPointLightShadows),S.push(M.numSpotLightShadows),S.push(M.numSpotLightShadowsWithMaps),S.push(M.numLightProbes),S.push(M.shadowMapType),S.push(M.toneMapping),S.push(M.numClippingPlanes),S.push(M.numClipIntersection),S.push(M.depthPacking)}function y(S,M){s.disableAll(),M.supportsVertexTextures&&s.enable(0),M.instancing&&s.enable(1),M.instancingColor&&s.enable(2),M.instancingMorph&&s.enable(3),M.matcap&&s.enable(4),M.envMap&&s.enable(5),M.normalMapObjectSpace&&s.enable(6),M.normalMapTangentSpace&&s.enable(7),M.clearcoat&&s.enable(8),M.iridescence&&s.enable(9),M.alphaTest&&s.enable(10),M.vertexColors&&s.enable(11),M.vertexAlphas&&s.enable(12),M.vertexUv1s&&s.enable(13),M.vertexUv2s&&s.enable(14),M.vertexUv3s&&s.enable(15),M.vertexTangents&&s.enable(16),M.anisotropy&&s.enable(17),M.alphaHash&&s.enable(18),M.batching&&s.enable(19),M.dispersion&&s.enable(20),M.batchingColor&&s.enable(21),S.push(s.mask),s.disableAll(),M.fog&&s.enable(0),M.useFog&&s.enable(1),M.flatShading&&s.enable(2),M.logarithmicDepthBuffer&&s.enable(3),M.skinning&&s.enable(4),M.morphTargets&&s.enable(5),M.morphNormals&&s.enable(6),M.morphColors&&s.enable(7),M.premultipliedAlpha&&s.enable(8),M.shadowMapEnabled&&s.enable(9),M.doubleSided&&s.enable(10),M.flipSided&&s.enable(11),M.useDepthPacking&&s.enable(12),M.dithering&&s.enable(13),M.transmission&&s.enable(14),M.sheen&&s.enable(15),M.opaque&&s.enable(16),M.pointsUvs&&s.enable(17),M.decodeVideoTexture&&s.enable(18),M.alphaToCoverage&&s.enable(19),S.push(s.mask)}function b(S){const M=v[S.type];let C;if(M){const H=Ot[M];C=ic.clone(H.uniforms)}else C=S.uniforms;return C}function B(S,M){let C;for(let H=0,z=u.length;H<z;H++){const j=u[H];if(j.cacheKey===M){C=j,++C.usedTimes;break}}return C===void 0&&(C=new mp(r,M,S,a),u.push(C)),C}function w(S){if(--S.usedTimes===0){const M=u.indexOf(S);u[M]=u[u.length-1],u.pop(),S.destroy()}}function R(S){l.remove(S)}function N(){l.dispose()}return{getParameters:d,getProgramCacheKey:h,getUniforms:b,acquireProgram:B,releaseProgram:w,releaseShaderCache:R,programs:u,dispose:N}}function Mp(){let r=new WeakMap;function e(o){return r.has(o)}function t(o){let s=r.get(o);return s===void 0&&(s={},r.set(o,s)),s}function i(o){r.delete(o)}function n(o,s,l){r.get(o)[s]=l}function a(){r=new WeakMap}return{has:e,get:t,remove:i,update:n,dispose:a}}function Sp(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.material.id!==e.material.id?r.material.id-e.material.id:r.z!==e.z?r.z-e.z:r.id-e.id}function So(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.z!==e.z?e.z-r.z:r.id-e.id}function yo(){const r=[];let e=0;const t=[],i=[],n=[];function a(){e=0,t.length=0,i.length=0,n.length=0}function o(f,p,m,v,x,d){let h=r[e];return h===void 0?(h={id:f.id,object:f,geometry:p,material:m,groupOrder:v,renderOrder:f.renderOrder,z:x,group:d},r[e]=h):(h.id=f.id,h.object=f,h.geometry=p,h.material=m,h.groupOrder=v,h.renderOrder=f.renderOrder,h.z=x,h.group=d),e++,h}function s(f,p,m,v,x,d){const h=o(f,p,m,v,x,d);m.transmission>0?i.push(h):m.transparent===!0?n.push(h):t.push(h)}function l(f,p,m,v,x,d){const h=o(f,p,m,v,x,d);m.transmission>0?i.unshift(h):m.transparent===!0?n.unshift(h):t.unshift(h)}function c(f,p){t.length>1&&t.sort(f||Sp),i.length>1&&i.sort(p||So),n.length>1&&n.sort(p||So)}function u(){for(let f=e,p=r.length;f<p;f++){const m=r[f];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:t,transmissive:i,transparent:n,init:a,push:s,unshift:l,finish:u,sort:c}}function yp(){let r=new WeakMap;function e(i,n){const a=r.get(i);let o;return a===void 0?(o=new yo,r.set(i,[o])):n>=a.length?(o=new yo,a.push(o)):o=a[n],o}function t(){r=new WeakMap}return{get:e,dispose:t}}function Ep(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new I,color:new De};break;case"SpotLight":t={position:new I,direction:new I,color:new De,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new I,color:new De,distance:0,decay:0};break;case"HemisphereLight":t={direction:new I,skyColor:new De,groundColor:new De};break;case"RectAreaLight":t={color:new De,position:new I,halfWidth:new I,halfHeight:new I};break}return r[e.id]=t,t}}}function Tp(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ne};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ne};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ne,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[e.id]=t,t}}}let bp=0;function Ap(r,e){return(e.castShadow?2:0)-(r.castShadow?2:0)+(e.map?1:0)-(r.map?1:0)}function wp(r){const e=new Ep,t=Tp(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new I);const n=new I,a=new Ze,o=new Ze;function s(c){let u=0,f=0,p=0;for(let S=0;S<9;S++)i.probe[S].set(0,0,0);let m=0,v=0,x=0,d=0,h=0,T=0,y=0,b=0,B=0,w=0,R=0;c.sort(Ap);for(let S=0,M=c.length;S<M;S++){const C=c[S],H=C.color,z=C.intensity,j=C.distance,Z=C.shadow&&C.shadow.map?C.shadow.map.texture:null;if(C.isAmbientLight)u+=H.r*z,f+=H.g*z,p+=H.b*z;else if(C.isLightProbe){for(let W=0;W<9;W++)i.probe[W].addScaledVector(C.sh.coefficients[W],z);R++}else if(C.isDirectionalLight){const W=e.get(C);if(W.color.copy(C.color).multiplyScalar(C.intensity),C.castShadow){const X=C.shadow,V=t.get(C);V.shadowIntensity=X.intensity,V.shadowBias=X.bias,V.shadowNormalBias=X.normalBias,V.shadowRadius=X.radius,V.shadowMapSize=X.mapSize,i.directionalShadow[m]=V,i.directionalShadowMap[m]=Z,i.directionalShadowMatrix[m]=C.shadow.matrix,T++}i.directional[m]=W,m++}else if(C.isSpotLight){const W=e.get(C);W.position.setFromMatrixPosition(C.matrixWorld),W.color.copy(H).multiplyScalar(z),W.distance=j,W.coneCos=Math.cos(C.angle),W.penumbraCos=Math.cos(C.angle*(1-C.penumbra)),W.decay=C.decay,i.spot[x]=W;const X=C.shadow;if(C.map&&(i.spotLightMap[B]=C.map,B++,X.updateMatrices(C),C.castShadow&&w++),i.spotLightMatrix[x]=X.matrix,C.castShadow){const V=t.get(C);V.shadowIntensity=X.intensity,V.shadowBias=X.bias,V.shadowNormalBias=X.normalBias,V.shadowRadius=X.radius,V.shadowMapSize=X.mapSize,i.spotShadow[x]=V,i.spotShadowMap[x]=Z,b++}x++}else if(C.isRectAreaLight){const W=e.get(C);W.color.copy(H).multiplyScalar(z),W.halfWidth.set(C.width*.5,0,0),W.halfHeight.set(0,C.height*.5,0),i.rectArea[d]=W,d++}else if(C.isPointLight){const W=e.get(C);if(W.color.copy(C.color).multiplyScalar(C.intensity),W.distance=C.distance,W.decay=C.decay,C.castShadow){const X=C.shadow,V=t.get(C);V.shadowIntensity=X.intensity,V.shadowBias=X.bias,V.shadowNormalBias=X.normalBias,V.shadowRadius=X.radius,V.shadowMapSize=X.mapSize,V.shadowCameraNear=X.camera.near,V.shadowCameraFar=X.camera.far,i.pointShadow[v]=V,i.pointShadowMap[v]=Z,i.pointShadowMatrix[v]=C.shadow.matrix,y++}i.point[v]=W,v++}else if(C.isHemisphereLight){const W=e.get(C);W.skyColor.copy(C.color).multiplyScalar(z),W.groundColor.copy(C.groundColor).multiplyScalar(z),i.hemi[h]=W,h++}}d>0&&(r.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=ne.LTC_FLOAT_1,i.rectAreaLTC2=ne.LTC_FLOAT_2):(i.rectAreaLTC1=ne.LTC_HALF_1,i.rectAreaLTC2=ne.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=f,i.ambient[2]=p;const N=i.hash;(N.directionalLength!==m||N.pointLength!==v||N.spotLength!==x||N.rectAreaLength!==d||N.hemiLength!==h||N.numDirectionalShadows!==T||N.numPointShadows!==y||N.numSpotShadows!==b||N.numSpotMaps!==B||N.numLightProbes!==R)&&(i.directional.length=m,i.spot.length=x,i.rectArea.length=d,i.point.length=v,i.hemi.length=h,i.directionalShadow.length=T,i.directionalShadowMap.length=T,i.pointShadow.length=y,i.pointShadowMap.length=y,i.spotShadow.length=b,i.spotShadowMap.length=b,i.directionalShadowMatrix.length=T,i.pointShadowMatrix.length=y,i.spotLightMatrix.length=b+B-w,i.spotLightMap.length=B,i.numSpotLightShadowsWithMaps=w,i.numLightProbes=R,N.directionalLength=m,N.pointLength=v,N.spotLength=x,N.rectAreaLength=d,N.hemiLength=h,N.numDirectionalShadows=T,N.numPointShadows=y,N.numSpotShadows=b,N.numSpotMaps=B,N.numLightProbes=R,i.version=bp++)}function l(c,u){let f=0,p=0,m=0,v=0,x=0;const d=u.matrixWorldInverse;for(let h=0,T=c.length;h<T;h++){const y=c[h];if(y.isDirectionalLight){const b=i.directional[f];b.direction.setFromMatrixPosition(y.matrixWorld),n.setFromMatrixPosition(y.target.matrixWorld),b.direction.sub(n),b.direction.transformDirection(d),f++}else if(y.isSpotLight){const b=i.spot[m];b.position.setFromMatrixPosition(y.matrixWorld),b.position.applyMatrix4(d),b.direction.setFromMatrixPosition(y.matrixWorld),n.setFromMatrixPosition(y.target.matrixWorld),b.direction.sub(n),b.direction.transformDirection(d),m++}else if(y.isRectAreaLight){const b=i.rectArea[v];b.position.setFromMatrixPosition(y.matrixWorld),b.position.applyMatrix4(d),o.identity(),a.copy(y.matrixWorld),a.premultiply(d),o.extractRotation(a),b.halfWidth.set(y.width*.5,0,0),b.halfHeight.set(0,y.height*.5,0),b.halfWidth.applyMatrix4(o),b.halfHeight.applyMatrix4(o),v++}else if(y.isPointLight){const b=i.point[p];b.position.setFromMatrixPosition(y.matrixWorld),b.position.applyMatrix4(d),p++}else if(y.isHemisphereLight){const b=i.hemi[x];b.direction.setFromMatrixPosition(y.matrixWorld),b.direction.transformDirection(d),x++}}}return{setup:s,setupView:l,state:i}}function Eo(r){const e=new wp(r),t=[],i=[];function n(u){c.camera=u,t.length=0,i.length=0}function a(u){t.push(u)}function o(u){i.push(u)}function s(){e.setup(t)}function l(u){e.setupView(t,u)}const c={lightsArray:t,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:n,state:c,setupLights:s,setupLightsView:l,pushLight:a,pushShadow:o}}function Rp(r){let e=new WeakMap;function t(n,a=0){const o=e.get(n);let s;return o===void 0?(s=new Eo(r),e.set(n,[s])):a>=o.length?(s=new Eo(r),o.push(s)):s=o[a],s}function i(){e=new WeakMap}return{get:t,dispose:i}}class Cp extends fr{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=bl,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class Pp extends fr{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const Up=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function Ip(r,e,t){let i=new Ca;const n=new Ne,a=new Ne,o=new je,s=new Cp({depthPacking:Al}),l=new Pp,c={},u=t.maxTextureSize,f={[Jt]:mt,[mt]:Jt,[Vt]:Vt},p=new oi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ne},radius:{value:4}},vertexShader:Up,fragmentShader:Lp}),m=p.clone();m.defines.HORIZONTAL_PASS=1;const v=new ci;v.setAttribute("position",new Dt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new bt(v,p),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ja;let h=this.type;this.render=function(w,R,N){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||w.length===0)return;const S=r.getRenderTarget(),M=r.getActiveCubeFace(),C=r.getActiveMipmapLevel(),H=r.state;H.setBlending($t),H.buffers.color.setClear(1,1,1,1),H.buffers.depth.setTest(!0),H.setScissorTest(!1);const z=h!==Ht&&this.type===Ht,j=h===Ht&&this.type!==Ht;for(let Z=0,W=w.length;Z<W;Z++){const X=w[Z],V=X.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",X,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;n.copy(V.mapSize);const re=V.getFrameExtents();if(n.multiply(re),a.copy(V.mapSize),(n.x>u||n.y>u)&&(n.x>u&&(a.x=Math.floor(u/re.x),n.x=a.x*re.x,V.mapSize.x=a.x),n.y>u&&(a.y=Math.floor(u/re.y),n.y=a.y*re.y,V.mapSize.y=a.y)),V.map===null||z===!0||j===!0){const Se=this.type!==Ht?{minFilter:Et,magFilter:Et}:{};V.map!==null&&V.map.dispose(),V.map=new gi(n.x,n.y,Se),V.map.texture.name=X.name+".shadowMap",V.camera.updateProjectionMatrix()}r.setRenderTarget(V.map),r.clear();const fe=V.getViewportCount();for(let Se=0;Se<fe;Se++){const Oe=V.getViewport(Se);o.set(a.x*Oe.x,a.y*Oe.y,a.x*Oe.z,a.y*Oe.w),H.viewport(o),V.updateMatrices(X,Se),i=V.getFrustum(),b(R,N,V.camera,X,this.type)}V.isPointLightShadow!==!0&&this.type===Ht&&T(V,N),V.needsUpdate=!1}h=this.type,d.needsUpdate=!1,r.setRenderTarget(S,M,C)};function T(w,R){const N=e.update(x);p.defines.VSM_SAMPLES!==w.blurSamples&&(p.defines.VSM_SAMPLES=w.blurSamples,m.defines.VSM_SAMPLES=w.blurSamples,p.needsUpdate=!0,m.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new gi(n.x,n.y)),p.uniforms.shadow_pass.value=w.map.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,r.setRenderTarget(w.mapPass),r.clear(),r.renderBufferDirect(R,null,N,p,x,null),m.uniforms.shadow_pass.value=w.mapPass.texture,m.uniforms.resolution.value=w.mapSize,m.uniforms.radius.value=w.radius,r.setRenderTarget(w.map),r.clear(),r.renderBufferDirect(R,null,N,m,x,null)}function y(w,R,N,S){let M=null;const C=N.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(C!==void 0)M=C;else if(M=N.isPointLight===!0?l:s,r.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const H=M.uuid,z=R.uuid;let j=c[H];j===void 0&&(j={},c[H]=j);let Z=j[z];Z===void 0&&(Z=M.clone(),j[z]=Z,R.addEventListener("dispose",B)),M=Z}if(M.visible=R.visible,M.wireframe=R.wireframe,S===Ht?M.side=R.shadowSide!==null?R.shadowSide:R.side:M.side=R.shadowSide!==null?R.shadowSide:f[R.side],M.alphaMap=R.alphaMap,M.alphaTest=R.alphaTest,M.map=R.map,M.clipShadows=R.clipShadows,M.clippingPlanes=R.clippingPlanes,M.clipIntersection=R.clipIntersection,M.displacementMap=R.displacementMap,M.displacementScale=R.displacementScale,M.displacementBias=R.displacementBias,M.wireframeLinewidth=R.wireframeLinewidth,M.linewidth=R.linewidth,N.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const H=r.properties.get(M);H.light=N}return M}function b(w,R,N,S,M){if(w.visible===!1)return;if(w.layers.test(R.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&M===Ht)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse,w.matrixWorld);const H=e.update(w),z=w.material;if(Array.isArray(z)){const j=H.groups;for(let Z=0,W=j.length;Z<W;Z++){const X=j[Z],V=z[X.materialIndex];if(V&&V.visible){const re=y(w,V,S,M);w.onBeforeShadow(r,w,R,N,H,re,X),r.renderBufferDirect(N,null,H,re,w,X),w.onAfterShadow(r,w,R,N,H,re,X)}}}else if(z.visible){const j=y(w,z,S,M);w.onBeforeShadow(r,w,R,N,H,j,null),r.renderBufferDirect(N,null,H,j,w,null),w.onAfterShadow(r,w,R,N,H,j,null)}}const C=w.children;for(let H=0,z=C.length;H<z;H++)b(C[H],R,N,S,M)}function B(w){w.target.removeEventListener("dispose",B);for(const R in c){const N=c[R],S=w.target.uuid;S in N&&(N[S].dispose(),delete N[S])}}}function Dp(r){function e(){let P=!1;const te=new je;let k=null;const K=new je(0,0,0,0);return{setMask:function(ie){k!==ie&&!P&&(r.colorMask(ie,ie,ie,ie),k=ie)},setLocked:function(ie){P=ie},setClear:function(ie,_e,We,et,lt){lt===!0&&(ie*=et,_e*=et,We*=et),te.set(ie,_e,We,et),K.equals(te)===!1&&(r.clearColor(ie,_e,We,et),K.copy(te))},reset:function(){P=!1,k=null,K.set(-1,0,0,0)}}}function t(){let P=!1,te=null,k=null,K=null;return{setTest:function(ie){ie?de(r.DEPTH_TEST):oe(r.DEPTH_TEST)},setMask:function(ie){te!==ie&&!P&&(r.depthMask(ie),te=ie)},setFunc:function(ie){if(k!==ie){switch(ie){case ll:r.depthFunc(r.NEVER);break;case cl:r.depthFunc(r.ALWAYS);break;case hl:r.depthFunc(r.LESS);break;case Tr:r.depthFunc(r.LEQUAL);break;case ul:r.depthFunc(r.EQUAL);break;case dl:r.depthFunc(r.GEQUAL);break;case pl:r.depthFunc(r.GREATER);break;case fl:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}k=ie}},setLocked:function(ie){P=ie},setClear:function(ie){K!==ie&&(r.clearDepth(ie),K=ie)},reset:function(){P=!1,te=null,k=null,K=null}}}function i(){let P=!1,te=null,k=null,K=null,ie=null,_e=null,We=null,et=null,lt=null;return{setTest:function(Be){P||(Be?de(r.STENCIL_TEST):oe(r.STENCIL_TEST))},setMask:function(Be){te!==Be&&!P&&(r.stencilMask(Be),te=Be)},setFunc:function(Be,zt,Lt){(k!==Be||K!==zt||ie!==Lt)&&(r.stencilFunc(Be,zt,Lt),k=Be,K=zt,ie=Lt)},setOp:function(Be,zt,Lt){(_e!==Be||We!==zt||et!==Lt)&&(r.stencilOp(Be,zt,Lt),_e=Be,We=zt,et=Lt)},setLocked:function(Be){P=Be},setClear:function(Be){lt!==Be&&(r.clearStencil(Be),lt=Be)},reset:function(){P=!1,te=null,k=null,K=null,ie=null,_e=null,We=null,et=null,lt=null}}}const n=new e,a=new t,o=new i,s=new WeakMap,l=new WeakMap;let c={},u={},f=new WeakMap,p=[],m=null,v=!1,x=null,d=null,h=null,T=null,y=null,b=null,B=null,w=new De(0,0,0),R=0,N=!1,S=null,M=null,C=null,H=null,z=null;const j=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Z=!1,W=0;const X=r.getParameter(r.VERSION);X.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(X)[1]),Z=W>=1):X.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),Z=W>=2);let V=null,re={};const fe=r.getParameter(r.SCISSOR_BOX),Se=r.getParameter(r.VIEWPORT),Oe=new je().fromArray(fe),ke=new je().fromArray(Se);function G(P,te,k,K){const ie=new Uint8Array(4),_e=r.createTexture();r.bindTexture(P,_e),r.texParameteri(P,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(P,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let We=0;We<k;We++)P===r.TEXTURE_3D||P===r.TEXTURE_2D_ARRAY?r.texImage3D(te,0,r.RGBA,1,1,K,0,r.RGBA,r.UNSIGNED_BYTE,ie):r.texImage2D(te+We,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,ie);return _e}const Q={};Q[r.TEXTURE_2D]=G(r.TEXTURE_2D,r.TEXTURE_2D,1),Q[r.TEXTURE_CUBE_MAP]=G(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[r.TEXTURE_2D_ARRAY]=G(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),Q[r.TEXTURE_3D]=G(r.TEXTURE_3D,r.TEXTURE_3D,1,1),n.setClear(0,0,0,1),a.setClear(1),o.setClear(0),de(r.DEPTH_TEST),a.setFunc(Tr),Ge(!1),ge(Za),de(r.CULL_FACE),$e($t);function de(P){c[P]!==!0&&(r.enable(P),c[P]=!0)}function oe(P){c[P]!==!1&&(r.disable(P),c[P]=!1)}function ye(P,te){return u[P]!==te?(r.bindFramebuffer(P,te),u[P]=te,P===r.DRAW_FRAMEBUFFER&&(u[r.FRAMEBUFFER]=te),P===r.FRAMEBUFFER&&(u[r.DRAW_FRAMEBUFFER]=te),!0):!1}function we(P,te){let k=p,K=!1;if(P){k=f.get(te),k===void 0&&(k=[],f.set(te,k));const ie=P.textures;if(k.length!==ie.length||k[0]!==r.COLOR_ATTACHMENT0){for(let _e=0,We=ie.length;_e<We;_e++)k[_e]=r.COLOR_ATTACHMENT0+_e;k.length=ie.length,K=!0}}else k[0]!==r.BACK&&(k[0]=r.BACK,K=!0);K&&r.drawBuffers(k)}function Ie(P){return m!==P?(r.useProgram(P),m=P,!0):!1}const Ke={[di]:r.FUNC_ADD,[Xo]:r.FUNC_SUBTRACT,[jo]:r.FUNC_REVERSE_SUBTRACT};Ke[qo]=r.MIN,Ke[Yo]=r.MAX;const A={[Ko]:r.ZERO,[Zo]:r.ONE,[Jo]:r.SRC_COLOR,[Mn]:r.SRC_ALPHA,[rl]:r.SRC_ALPHA_SATURATE,[tl]:r.DST_COLOR,[Qo]:r.DST_ALPHA,[$o]:r.ONE_MINUS_SRC_COLOR,[Sn]:r.ONE_MINUS_SRC_ALPHA,[il]:r.ONE_MINUS_DST_COLOR,[el]:r.ONE_MINUS_DST_ALPHA,[nl]:r.CONSTANT_COLOR,[al]:r.ONE_MINUS_CONSTANT_COLOR,[sl]:r.CONSTANT_ALPHA,[ol]:r.ONE_MINUS_CONSTANT_ALPHA};function $e(P,te,k,K,ie,_e,We,et,lt,Be){if(P===$t){v===!0&&(oe(r.BLEND),v=!1);return}if(v===!1&&(de(r.BLEND),v=!0),P!==Wo){if(P!==x||Be!==N){if((d!==di||y!==di)&&(r.blendEquation(r.FUNC_ADD),d=di,y=di),Be)switch(P){case Ri:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case $a:r.blendFunc(r.ONE,r.ONE);break;case Qa:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case es:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case Ri:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case $a:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case Qa:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case es:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}h=null,T=null,b=null,B=null,w.set(0,0,0),R=0,x=P,N=Be}return}ie=ie||te,_e=_e||k,We=We||K,(te!==d||ie!==y)&&(r.blendEquationSeparate(Ke[te],Ke[ie]),d=te,y=ie),(k!==h||K!==T||_e!==b||We!==B)&&(r.blendFuncSeparate(A[k],A[K],A[_e],A[We]),h=k,T=K,b=_e,B=We),(et.equals(w)===!1||lt!==R)&&(r.blendColor(et.r,et.g,et.b,lt),w.copy(et),R=lt),x=P,N=!1}function He(P,te){P.side===Vt?oe(r.CULL_FACE):de(r.CULL_FACE);let k=P.side===mt;te&&(k=!k),Ge(k),P.blending===Ri&&P.transparent===!1?$e($t):$e(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),n.setMask(P.colorWrite);const K=P.stencilWrite;o.setTest(K),K&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),be(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?de(r.SAMPLE_ALPHA_TO_COVERAGE):oe(r.SAMPLE_ALPHA_TO_COVERAGE)}function Ge(P){S!==P&&(P?r.frontFace(r.CW):r.frontFace(r.CCW),S=P)}function ge(P){P!==Vo?(de(r.CULL_FACE),P!==M&&(P===Za?r.cullFace(r.BACK):P===ko?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):oe(r.CULL_FACE),M=P}function Qe(P){P!==C&&(Z&&r.lineWidth(P),C=P)}function be(P,te,k){P?(de(r.POLYGON_OFFSET_FILL),(H!==te||z!==k)&&(r.polygonOffset(te,k),H=te,z=k)):oe(r.POLYGON_OFFSET_FILL)}function Re(P){P?de(r.SCISSOR_TEST):oe(r.SCISSOR_TEST)}function E(P){P===void 0&&(P=r.TEXTURE0+j-1),V!==P&&(r.activeTexture(P),V=P)}function g(P,te,k){k===void 0&&(V===null?k=r.TEXTURE0+j-1:k=V);let K=re[k];K===void 0&&(K={type:void 0,texture:void 0},re[k]=K),(K.type!==P||K.texture!==te)&&(V!==k&&(r.activeTexture(k),V=k),r.bindTexture(P,te||Q[P]),K.type=P,K.texture=te)}function F(){const P=re[V];P!==void 0&&P.type!==void 0&&(r.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function q(){try{r.compressedTexImage2D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function J(){try{r.compressedTexImage3D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Y(){try{r.texSubImage2D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ve(){try{r.texSubImage3D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ae(){try{r.compressedTexSubImage2D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ce(){try{r.compressedTexSubImage3D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Ce(){try{r.texStorage2D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ee(){try{r.texStorage3D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function he(){try{r.texImage2D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Fe(){try{r.texImage3D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Te(P){Oe.equals(P)===!1&&(r.scissor(P.x,P.y,P.z,P.w),Oe.copy(P))}function le(P){ke.equals(P)===!1&&(r.viewport(P.x,P.y,P.z,P.w),ke.copy(P))}function Ae(P,te){let k=l.get(te);k===void 0&&(k=new WeakMap,l.set(te,k));let K=k.get(P);K===void 0&&(K=r.getUniformBlockIndex(te,P.name),k.set(P,K))}function Le(P,te){const k=l.get(te).get(P);s.get(te)!==k&&(r.uniformBlockBinding(te,k,P.__bindingPointIndex),s.set(te,k))}function Ye(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),c={},V=null,re={},u={},f=new WeakMap,p=[],m=null,v=!1,x=null,d=null,h=null,T=null,y=null,b=null,B=null,w=new De(0,0,0),R=0,N=!1,S=null,M=null,C=null,H=null,z=null,Oe.set(0,0,r.canvas.width,r.canvas.height),ke.set(0,0,r.canvas.width,r.canvas.height),n.reset(),a.reset(),o.reset()}return{buffers:{color:n,depth:a,stencil:o},enable:de,disable:oe,bindFramebuffer:ye,drawBuffers:we,useProgram:Ie,setBlending:$e,setMaterial:He,setFlipSided:Ge,setCullFace:ge,setLineWidth:Qe,setPolygonOffset:be,setScissorTest:Re,activeTexture:E,bindTexture:g,unbindTexture:F,compressedTexImage2D:q,compressedTexImage3D:J,texImage2D:he,texImage3D:Fe,updateUBOMapping:Ae,uniformBlockBinding:Le,texStorage2D:Ce,texStorage3D:ee,texSubImage2D:Y,texSubImage3D:ve,compressedTexSubImage2D:ae,compressedTexSubImage3D:ce,scissor:Te,viewport:le,reset:Ye}}function To(r,e,t,i){const n=Np(i);switch(t){case ss:return r*e;case ls:return r*e;case cs:return r*e*2;case hs:return r*e/n.components*n.byteLength;case Pn:return r*e/n.components*n.byteLength;case us:return r*e*2/n.components*n.byteLength;case Un:return r*e*2/n.components*n.byteLength;case os:return r*e*3/n.components*n.byteLength;case Rt:return r*e*4/n.components*n.byteLength;case Ln:return r*e*4/n.components*n.byteLength;case wr:case Rr:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*8;case Cr:case Pr:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case Dn:case On:return Math.max(r,16)*Math.max(e,8)/4;case In:case Nn:return Math.max(r,8)*Math.max(e,8)/2;case Fn:case Bn:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*8;case zn:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case Hn:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case Vn:return Math.floor((r+4)/5)*Math.floor((e+3)/4)*16;case kn:return Math.floor((r+4)/5)*Math.floor((e+4)/5)*16;case Gn:return Math.floor((r+5)/6)*Math.floor((e+4)/5)*16;case Wn:return Math.floor((r+5)/6)*Math.floor((e+5)/6)*16;case Xn:return Math.floor((r+7)/8)*Math.floor((e+4)/5)*16;case jn:return Math.floor((r+7)/8)*Math.floor((e+5)/6)*16;case qn:return Math.floor((r+7)/8)*Math.floor((e+7)/8)*16;case Yn:return Math.floor((r+9)/10)*Math.floor((e+4)/5)*16;case Kn:return Math.floor((r+9)/10)*Math.floor((e+5)/6)*16;case Zn:return Math.floor((r+9)/10)*Math.floor((e+7)/8)*16;case Jn:return Math.floor((r+9)/10)*Math.floor((e+9)/10)*16;case $n:return Math.floor((r+11)/12)*Math.floor((e+9)/10)*16;case Qn:return Math.floor((r+11)/12)*Math.floor((e+11)/12)*16;case Ur:case ea:case ta:return Math.ceil(r/4)*Math.ceil(e/4)*16;case ds:case ia:return Math.ceil(r/4)*Math.ceil(e/4)*8;case ra:case na:return Math.ceil(r/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Np(r){switch(r){case kt:case rs:return{byteLength:1,components:1};case rr:case ns:case nr:return{byteLength:2,components:1};case Rn:case Cn:return{byteLength:2,components:4};case mi:case wn:case Gt:return{byteLength:4,components:1};case as:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${r}.`)}function Op(r,e,t,i,n,a,o){const s=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ne,u=new WeakMap;let f;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(E,g){return m?new OffscreenCanvas(E,g):Fr("canvas")}function x(E,g,F){let q=1;const J=Re(E);if((J.width>F||J.height>F)&&(q=F/Math.max(J.width,J.height)),q<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const Y=Math.floor(q*J.width),ve=Math.floor(q*J.height);f===void 0&&(f=v(Y,ve));const ae=g?v(Y,ve):f;return ae.width=Y,ae.height=ve,ae.getContext("2d").drawImage(E,0,0,Y,ve),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+Y+"x"+ve+")."),ae}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),E;return E}function d(E){return E.generateMipmaps&&E.minFilter!==Et&&E.minFilter!==wt}function h(E){r.generateMipmap(E)}function T(E,g,F,q,J=!1){if(E!==null){if(r[E]!==void 0)return r[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let Y=g;if(g===r.RED&&(F===r.FLOAT&&(Y=r.R32F),F===r.HALF_FLOAT&&(Y=r.R16F),F===r.UNSIGNED_BYTE&&(Y=r.R8)),g===r.RED_INTEGER&&(F===r.UNSIGNED_BYTE&&(Y=r.R8UI),F===r.UNSIGNED_SHORT&&(Y=r.R16UI),F===r.UNSIGNED_INT&&(Y=r.R32UI),F===r.BYTE&&(Y=r.R8I),F===r.SHORT&&(Y=r.R16I),F===r.INT&&(Y=r.R32I)),g===r.RG&&(F===r.FLOAT&&(Y=r.RG32F),F===r.HALF_FLOAT&&(Y=r.RG16F),F===r.UNSIGNED_BYTE&&(Y=r.RG8)),g===r.RG_INTEGER&&(F===r.UNSIGNED_BYTE&&(Y=r.RG8UI),F===r.UNSIGNED_SHORT&&(Y=r.RG16UI),F===r.UNSIGNED_INT&&(Y=r.RG32UI),F===r.BYTE&&(Y=r.RG8I),F===r.SHORT&&(Y=r.RG16I),F===r.INT&&(Y=r.RG32I)),g===r.RGB&&F===r.UNSIGNED_INT_5_9_9_9_REV&&(Y=r.RGB9_E5),g===r.RGBA){const ve=J?Ir:ze.getTransfer(q);F===r.FLOAT&&(Y=r.RGBA32F),F===r.HALF_FLOAT&&(Y=r.RGBA16F),F===r.UNSIGNED_BYTE&&(Y=ve===Xe?r.SRGB8_ALPHA8:r.RGBA8),F===r.UNSIGNED_SHORT_4_4_4_4&&(Y=r.RGBA4),F===r.UNSIGNED_SHORT_5_5_5_1&&(Y=r.RGB5_A1)}return(Y===r.R16F||Y===r.R32F||Y===r.RG16F||Y===r.RG32F||Y===r.RGBA16F||Y===r.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function y(E,g){let F;return E?g===null||g===mi||g===Ui?F=r.DEPTH24_STENCIL8:g===Gt?F=r.DEPTH32F_STENCIL8:g===rr&&(F=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===mi||g===Ui?F=r.DEPTH_COMPONENT24:g===Gt?F=r.DEPTH_COMPONENT32F:g===rr&&(F=r.DEPTH_COMPONENT16),F}function b(E,g){return d(E)===!0||E.isFramebufferTexture&&E.minFilter!==Et&&E.minFilter!==wt?Math.log2(Math.max(g.width,g.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?g.mipmaps.length:1}function B(E){const g=E.target;g.removeEventListener("dispose",B),R(g),g.isVideoTexture&&u.delete(g)}function w(E){const g=E.target;g.removeEventListener("dispose",w),S(g)}function R(E){const g=i.get(E);if(g.__webglInit===void 0)return;const F=E.source,q=p.get(F);if(q){const J=q[g.__cacheKey];J.usedTimes--,J.usedTimes===0&&N(E),Object.keys(q).length===0&&p.delete(F)}i.remove(E)}function N(E){const g=i.get(E);r.deleteTexture(g.__webglTexture);const F=E.source,q=p.get(F);delete q[g.__cacheKey],o.memory.textures--}function S(E){const g=i.get(E);if(E.depthTexture&&E.depthTexture.dispose(),E.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(g.__webglFramebuffer[q]))for(let J=0;J<g.__webglFramebuffer[q].length;J++)r.deleteFramebuffer(g.__webglFramebuffer[q][J]);else r.deleteFramebuffer(g.__webglFramebuffer[q]);g.__webglDepthbuffer&&r.deleteRenderbuffer(g.__webglDepthbuffer[q])}else{if(Array.isArray(g.__webglFramebuffer))for(let q=0;q<g.__webglFramebuffer.length;q++)r.deleteFramebuffer(g.__webglFramebuffer[q]);else r.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&r.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&r.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let q=0;q<g.__webglColorRenderbuffer.length;q++)g.__webglColorRenderbuffer[q]&&r.deleteRenderbuffer(g.__webglColorRenderbuffer[q]);g.__webglDepthRenderbuffer&&r.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const F=E.textures;for(let q=0,J=F.length;q<J;q++){const Y=i.get(F[q]);Y.__webglTexture&&(r.deleteTexture(Y.__webglTexture),o.memory.textures--),i.remove(F[q])}i.remove(E)}let M=0;function C(){M=0}function H(){const E=M;return E>=n.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+n.maxTextures),M+=1,E}function z(E){const g=[];return g.push(E.wrapS),g.push(E.wrapT),g.push(E.wrapR||0),g.push(E.magFilter),g.push(E.minFilter),g.push(E.anisotropy),g.push(E.internalFormat),g.push(E.format),g.push(E.type),g.push(E.generateMipmaps),g.push(E.premultiplyAlpha),g.push(E.flipY),g.push(E.unpackAlignment),g.push(E.colorSpace),g.join()}function j(E,g){const F=i.get(E);if(E.isVideoTexture&&Qe(E),E.isRenderTargetTexture===!1&&E.version>0&&F.__version!==E.version){const q=E.image;if(q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ke(F,E,g);return}}t.bindTexture(r.TEXTURE_2D,F.__webglTexture,r.TEXTURE0+g)}function Z(E,g){const F=i.get(E);if(E.version>0&&F.__version!==E.version){ke(F,E,g);return}t.bindTexture(r.TEXTURE_2D_ARRAY,F.__webglTexture,r.TEXTURE0+g)}function W(E,g){const F=i.get(E);if(E.version>0&&F.__version!==E.version){ke(F,E,g);return}t.bindTexture(r.TEXTURE_3D,F.__webglTexture,r.TEXTURE0+g)}function X(E,g){const F=i.get(E);if(E.version>0&&F.__version!==E.version){G(F,E,g);return}t.bindTexture(r.TEXTURE_CUBE_MAP,F.__webglTexture,r.TEXTURE0+g)}const V={[Tn]:r.REPEAT,[pi]:r.CLAMP_TO_EDGE,[bn]:r.MIRRORED_REPEAT},re={[Et]:r.NEAREST,[Tl]:r.NEAREST_MIPMAP_NEAREST,[Ar]:r.NEAREST_MIPMAP_LINEAR,[wt]:r.LINEAR,[An]:r.LINEAR_MIPMAP_NEAREST,[fi]:r.LINEAR_MIPMAP_LINEAR},fe={[Rl]:r.NEVER,[Dl]:r.ALWAYS,[Cl]:r.LESS,[ms]:r.LEQUAL,[Pl]:r.EQUAL,[Il]:r.GEQUAL,[Ul]:r.GREATER,[Ll]:r.NOTEQUAL};function Se(E,g){if(g.type===Gt&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===wt||g.magFilter===An||g.magFilter===Ar||g.magFilter===fi||g.minFilter===wt||g.minFilter===An||g.minFilter===Ar||g.minFilter===fi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(E,r.TEXTURE_WRAP_S,V[g.wrapS]),r.texParameteri(E,r.TEXTURE_WRAP_T,V[g.wrapT]),(E===r.TEXTURE_3D||E===r.TEXTURE_2D_ARRAY)&&r.texParameteri(E,r.TEXTURE_WRAP_R,V[g.wrapR]),r.texParameteri(E,r.TEXTURE_MAG_FILTER,re[g.magFilter]),r.texParameteri(E,r.TEXTURE_MIN_FILTER,re[g.minFilter]),g.compareFunction&&(r.texParameteri(E,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(E,r.TEXTURE_COMPARE_FUNC,fe[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Et||g.minFilter!==Ar&&g.minFilter!==fi||g.type===Gt&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||i.get(g).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");r.texParameterf(E,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,n.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy}}}function Oe(E,g){let F=!1;E.__webglInit===void 0&&(E.__webglInit=!0,g.addEventListener("dispose",B));const q=g.source;let J=p.get(q);J===void 0&&(J={},p.set(q,J));const Y=z(g);if(Y!==E.__cacheKey){J[Y]===void 0&&(J[Y]={texture:r.createTexture(),usedTimes:0},o.memory.textures++,F=!0),J[Y].usedTimes++;const ve=J[E.__cacheKey];ve!==void 0&&(J[E.__cacheKey].usedTimes--,ve.usedTimes===0&&N(g)),E.__cacheKey=Y,E.__webglTexture=J[Y].texture}return F}function ke(E,g,F){let q=r.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(q=r.TEXTURE_2D_ARRAY),g.isData3DTexture&&(q=r.TEXTURE_3D);const J=Oe(E,g),Y=g.source;t.bindTexture(q,E.__webglTexture,r.TEXTURE0+F);const ve=i.get(Y);if(Y.version!==ve.__version||J===!0){t.activeTexture(r.TEXTURE0+F);const ae=ze.getPrimaries(ze.workingColorSpace),ce=g.colorSpace===ei?null:ze.getPrimaries(g.colorSpace),Ce=g.colorSpace===ei||ae===ce?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,g.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,g.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ce);let ee=x(g.image,!1,n.maxTextureSize);ee=be(g,ee);const he=a.convert(g.format,g.colorSpace),Fe=a.convert(g.type);let Te=T(g.internalFormat,he,Fe,g.colorSpace,g.isVideoTexture);Se(q,g);let le;const Ae=g.mipmaps,Le=g.isVideoTexture!==!0,Ye=ve.__version===void 0||J===!0,P=Y.dataReady,te=b(g,ee);if(g.isDepthTexture)Te=y(g.format===Ii,g.type),Ye&&(Le?t.texStorage2D(r.TEXTURE_2D,1,Te,ee.width,ee.height):t.texImage2D(r.TEXTURE_2D,0,Te,ee.width,ee.height,0,he,Fe,null));else if(g.isDataTexture)if(Ae.length>0){Le&&Ye&&t.texStorage2D(r.TEXTURE_2D,te,Te,Ae[0].width,Ae[0].height);for(let k=0,K=Ae.length;k<K;k++)le=Ae[k],Le?P&&t.texSubImage2D(r.TEXTURE_2D,k,0,0,le.width,le.height,he,Fe,le.data):t.texImage2D(r.TEXTURE_2D,k,Te,le.width,le.height,0,he,Fe,le.data);g.generateMipmaps=!1}else Le?(Ye&&t.texStorage2D(r.TEXTURE_2D,te,Te,ee.width,ee.height),P&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,ee.width,ee.height,he,Fe,ee.data)):t.texImage2D(r.TEXTURE_2D,0,Te,ee.width,ee.height,0,he,Fe,ee.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Le&&Ye&&t.texStorage3D(r.TEXTURE_2D_ARRAY,te,Te,Ae[0].width,Ae[0].height,ee.depth);for(let k=0,K=Ae.length;k<K;k++)if(le=Ae[k],g.format!==Rt)if(he!==null)if(Le){if(P)if(g.layerUpdates.size>0){const ie=To(le.width,le.height,g.format,g.type);for(const _e of g.layerUpdates){const We=le.data.subarray(_e*ie/le.data.BYTES_PER_ELEMENT,(_e+1)*ie/le.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,k,0,0,_e,le.width,le.height,1,he,We,0,0)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,k,0,0,0,le.width,le.height,ee.depth,he,le.data,0,0)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,k,Te,le.width,le.height,ee.depth,0,le.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Le?P&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,k,0,0,0,le.width,le.height,ee.depth,he,Fe,le.data):t.texImage3D(r.TEXTURE_2D_ARRAY,k,Te,le.width,le.height,ee.depth,0,he,Fe,le.data)}else{Le&&Ye&&t.texStorage2D(r.TEXTURE_2D,te,Te,Ae[0].width,Ae[0].height);for(let k=0,K=Ae.length;k<K;k++)le=Ae[k],g.format!==Rt?he!==null?Le?P&&t.compressedTexSubImage2D(r.TEXTURE_2D,k,0,0,le.width,le.height,he,le.data):t.compressedTexImage2D(r.TEXTURE_2D,k,Te,le.width,le.height,0,le.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Le?P&&t.texSubImage2D(r.TEXTURE_2D,k,0,0,le.width,le.height,he,Fe,le.data):t.texImage2D(r.TEXTURE_2D,k,Te,le.width,le.height,0,he,Fe,le.data)}else if(g.isDataArrayTexture)if(Le){if(Ye&&t.texStorage3D(r.TEXTURE_2D_ARRAY,te,Te,ee.width,ee.height,ee.depth),P)if(g.layerUpdates.size>0){const k=To(ee.width,ee.height,g.format,g.type);for(const K of g.layerUpdates){const ie=ee.data.subarray(K*k/ee.data.BYTES_PER_ELEMENT,(K+1)*k/ee.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,K,ee.width,ee.height,1,he,Fe,ie)}g.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,ee.width,ee.height,ee.depth,he,Fe,ee.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,Te,ee.width,ee.height,ee.depth,0,he,Fe,ee.data);else if(g.isData3DTexture)Le?(Ye&&t.texStorage3D(r.TEXTURE_3D,te,Te,ee.width,ee.height,ee.depth),P&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,ee.width,ee.height,ee.depth,he,Fe,ee.data)):t.texImage3D(r.TEXTURE_3D,0,Te,ee.width,ee.height,ee.depth,0,he,Fe,ee.data);else if(g.isFramebufferTexture){if(Ye)if(Le)t.texStorage2D(r.TEXTURE_2D,te,Te,ee.width,ee.height);else{let k=ee.width,K=ee.height;for(let ie=0;ie<te;ie++)t.texImage2D(r.TEXTURE_2D,ie,Te,k,K,0,he,Fe,null),k>>=1,K>>=1}}else if(Ae.length>0){if(Le&&Ye){const k=Re(Ae[0]);t.texStorage2D(r.TEXTURE_2D,te,Te,k.width,k.height)}for(let k=0,K=Ae.length;k<K;k++)le=Ae[k],Le?P&&t.texSubImage2D(r.TEXTURE_2D,k,0,0,he,Fe,le):t.texImage2D(r.TEXTURE_2D,k,Te,he,Fe,le);g.generateMipmaps=!1}else if(Le){if(Ye){const k=Re(ee);t.texStorage2D(r.TEXTURE_2D,te,Te,k.width,k.height)}P&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,he,Fe,ee)}else t.texImage2D(r.TEXTURE_2D,0,Te,he,Fe,ee);d(g)&&h(q),ve.__version=Y.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function G(E,g,F){if(g.image.length!==6)return;const q=Oe(E,g),J=g.source;t.bindTexture(r.TEXTURE_CUBE_MAP,E.__webglTexture,r.TEXTURE0+F);const Y=i.get(J);if(J.version!==Y.__version||q===!0){t.activeTexture(r.TEXTURE0+F);const ve=ze.getPrimaries(ze.workingColorSpace),ae=g.colorSpace===ei?null:ze.getPrimaries(g.colorSpace),ce=g.colorSpace===ei||ve===ae?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,g.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,g.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,ce);const Ce=g.isCompressedTexture||g.image[0].isCompressedTexture,ee=g.image[0]&&g.image[0].isDataTexture,he=[];for(let K=0;K<6;K++)!Ce&&!ee?he[K]=x(g.image[K],!0,n.maxCubemapSize):he[K]=ee?g.image[K].image:g.image[K],he[K]=be(g,he[K]);const Fe=he[0],Te=a.convert(g.format,g.colorSpace),le=a.convert(g.type),Ae=T(g.internalFormat,Te,le,g.colorSpace),Le=g.isVideoTexture!==!0,Ye=Y.__version===void 0||q===!0,P=J.dataReady;let te=b(g,Fe);Se(r.TEXTURE_CUBE_MAP,g);let k;if(Ce){Le&&Ye&&t.texStorage2D(r.TEXTURE_CUBE_MAP,te,Ae,Fe.width,Fe.height);for(let K=0;K<6;K++){k=he[K].mipmaps;for(let ie=0;ie<k.length;ie++){const _e=k[ie];g.format!==Rt?Te!==null?Le?P&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie,0,0,_e.width,_e.height,Te,_e.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie,Ae,_e.width,_e.height,0,_e.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Le?P&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie,0,0,_e.width,_e.height,Te,le,_e.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie,Ae,_e.width,_e.height,0,Te,le,_e.data)}}}else{if(k=g.mipmaps,Le&&Ye){k.length>0&&te++;const K=Re(he[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,te,Ae,K.width,K.height)}for(let K=0;K<6;K++)if(ee){Le?P&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,he[K].width,he[K].height,Te,le,he[K].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ae,he[K].width,he[K].height,0,Te,le,he[K].data);for(let ie=0;ie<k.length;ie++){const _e=k[ie].image[K].image;Le?P&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie+1,0,0,_e.width,_e.height,Te,le,_e.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie+1,Ae,_e.width,_e.height,0,Te,le,_e.data)}}else{Le?P&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Te,le,he[K]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ae,Te,le,he[K]);for(let ie=0;ie<k.length;ie++){const _e=k[ie];Le?P&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie+1,0,0,Te,le,_e.image[K]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,ie+1,Ae,Te,le,_e.image[K])}}}d(g)&&h(r.TEXTURE_CUBE_MAP),Y.__version=J.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function Q(E,g,F,q,J,Y){const ve=a.convert(F.format,F.colorSpace),ae=a.convert(F.type),ce=T(F.internalFormat,ve,ae,F.colorSpace);if(!i.get(g).__hasExternalTextures){const Ce=Math.max(1,g.width>>Y),ee=Math.max(1,g.height>>Y);J===r.TEXTURE_3D||J===r.TEXTURE_2D_ARRAY?t.texImage3D(J,Y,ce,Ce,ee,g.depth,0,ve,ae,null):t.texImage2D(J,Y,ce,Ce,ee,0,ve,ae,null)}t.bindFramebuffer(r.FRAMEBUFFER,E),ge(g)?s.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,q,J,i.get(F).__webglTexture,0,Ge(g)):(J===r.TEXTURE_2D||J>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,q,J,i.get(F).__webglTexture,Y),t.bindFramebuffer(r.FRAMEBUFFER,null)}function de(E,g,F){if(r.bindRenderbuffer(r.RENDERBUFFER,E),g.depthBuffer){const q=g.depthTexture,J=q&&q.isDepthTexture?q.type:null,Y=y(g.stencilBuffer,J),ve=g.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ae=Ge(g);ge(g)?s.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,ae,Y,g.width,g.height):F?r.renderbufferStorageMultisample(r.RENDERBUFFER,ae,Y,g.width,g.height):r.renderbufferStorage(r.RENDERBUFFER,Y,g.width,g.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,ve,r.RENDERBUFFER,E)}else{const q=g.textures;for(let J=0;J<q.length;J++){const Y=q[J],ve=a.convert(Y.format,Y.colorSpace),ae=a.convert(Y.type),ce=T(Y.internalFormat,ve,ae,Y.colorSpace),Ce=Ge(g);F&&ge(g)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,Ce,ce,g.width,g.height):ge(g)?s.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Ce,ce,g.width,g.height):r.renderbufferStorage(r.RENDERBUFFER,ce,g.width,g.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function oe(E,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,E),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(g.depthTexture).__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),j(g.depthTexture,0);const F=i.get(g.depthTexture).__webglTexture,q=Ge(g);if(g.depthTexture.format===Li)ge(g)?s.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,F,0,q):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,F,0);else if(g.depthTexture.format===Ii)ge(g)?s.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,F,0,q):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,F,0);else throw new Error("Unknown depthTexture format")}function ye(E){const g=i.get(E),F=E.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==E.depthTexture){const q=E.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),q){const J=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,q.removeEventListener("dispose",J)};q.addEventListener("dispose",J),g.__depthDisposeCallback=J}g.__boundDepthTexture=q}if(E.depthTexture&&!g.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");oe(g.__webglFramebuffer,E)}else if(F){g.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(t.bindFramebuffer(r.FRAMEBUFFER,g.__webglFramebuffer[q]),g.__webglDepthbuffer[q]===void 0)g.__webglDepthbuffer[q]=r.createRenderbuffer(),de(g.__webglDepthbuffer[q],E,!1);else{const J=E.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Y=g.__webglDepthbuffer[q];r.bindRenderbuffer(r.RENDERBUFFER,Y),r.framebufferRenderbuffer(r.FRAMEBUFFER,J,r.RENDERBUFFER,Y)}}else if(t.bindFramebuffer(r.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=r.createRenderbuffer(),de(g.__webglDepthbuffer,E,!1);else{const q=E.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,J=g.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,J),r.framebufferRenderbuffer(r.FRAMEBUFFER,q,r.RENDERBUFFER,J)}t.bindFramebuffer(r.FRAMEBUFFER,null)}function we(E,g,F){const q=i.get(E);g!==void 0&&Q(q.__webglFramebuffer,E,E.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),F!==void 0&&ye(E)}function Ie(E){const g=E.texture,F=i.get(E),q=i.get(g);E.addEventListener("dispose",w);const J=E.textures,Y=E.isWebGLCubeRenderTarget===!0,ve=J.length>1;if(ve||(q.__webglTexture===void 0&&(q.__webglTexture=r.createTexture()),q.__version=g.version,o.memory.textures++),Y){F.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(g.mipmaps&&g.mipmaps.length>0){F.__webglFramebuffer[ae]=[];for(let ce=0;ce<g.mipmaps.length;ce++)F.__webglFramebuffer[ae][ce]=r.createFramebuffer()}else F.__webglFramebuffer[ae]=r.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){F.__webglFramebuffer=[];for(let ae=0;ae<g.mipmaps.length;ae++)F.__webglFramebuffer[ae]=r.createFramebuffer()}else F.__webglFramebuffer=r.createFramebuffer();if(ve)for(let ae=0,ce=J.length;ae<ce;ae++){const Ce=i.get(J[ae]);Ce.__webglTexture===void 0&&(Ce.__webglTexture=r.createTexture(),o.memory.textures++)}if(E.samples>0&&ge(E)===!1){F.__webglMultisampledFramebuffer=r.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let ae=0;ae<J.length;ae++){const ce=J[ae];F.__webglColorRenderbuffer[ae]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,F.__webglColorRenderbuffer[ae]);const Ce=a.convert(ce.format,ce.colorSpace),ee=a.convert(ce.type),he=T(ce.internalFormat,Ce,ee,ce.colorSpace,E.isXRRenderTarget===!0),Fe=Ge(E);r.renderbufferStorageMultisample(r.RENDERBUFFER,Fe,he,E.width,E.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ae,r.RENDERBUFFER,F.__webglColorRenderbuffer[ae])}r.bindRenderbuffer(r.RENDERBUFFER,null),E.depthBuffer&&(F.__webglDepthRenderbuffer=r.createRenderbuffer(),de(F.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(Y){t.bindTexture(r.TEXTURE_CUBE_MAP,q.__webglTexture),Se(r.TEXTURE_CUBE_MAP,g);for(let ae=0;ae<6;ae++)if(g.mipmaps&&g.mipmaps.length>0)for(let ce=0;ce<g.mipmaps.length;ce++)Q(F.__webglFramebuffer[ae][ce],E,g,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ae,ce);else Q(F.__webglFramebuffer[ae],E,g,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);d(g)&&h(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ve){for(let ae=0,ce=J.length;ae<ce;ae++){const Ce=J[ae],ee=i.get(Ce);t.bindTexture(r.TEXTURE_2D,ee.__webglTexture),Se(r.TEXTURE_2D,Ce),Q(F.__webglFramebuffer,E,Ce,r.COLOR_ATTACHMENT0+ae,r.TEXTURE_2D,0),d(Ce)&&h(r.TEXTURE_2D)}t.unbindTexture()}else{let ae=r.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(ae=E.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(ae,q.__webglTexture),Se(ae,g),g.mipmaps&&g.mipmaps.length>0)for(let ce=0;ce<g.mipmaps.length;ce++)Q(F.__webglFramebuffer[ce],E,g,r.COLOR_ATTACHMENT0,ae,ce);else Q(F.__webglFramebuffer,E,g,r.COLOR_ATTACHMENT0,ae,0);d(g)&&h(ae),t.unbindTexture()}E.depthBuffer&&ye(E)}function Ke(E){const g=E.textures;for(let F=0,q=g.length;F<q;F++){const J=g[F];if(d(J)){const Y=E.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:r.TEXTURE_2D,ve=i.get(J).__webglTexture;t.bindTexture(Y,ve),h(Y),t.unbindTexture()}}}const A=[],$e=[];function He(E){if(E.samples>0){if(ge(E)===!1){const g=E.textures,F=E.width,q=E.height;let J=r.COLOR_BUFFER_BIT;const Y=E.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ve=i.get(E),ae=g.length>1;if(ae)for(let ce=0;ce<g.length;ce++)t.bindFramebuffer(r.FRAMEBUFFER,ve.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ce,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,ve.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+ce,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,ve.__webglMultisampledFramebuffer),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,ve.__webglFramebuffer);for(let ce=0;ce<g.length;ce++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(J|=r.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(J|=r.STENCIL_BUFFER_BIT)),ae){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,ve.__webglColorRenderbuffer[ce]);const Ce=i.get(g[ce]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Ce,0)}r.blitFramebuffer(0,0,F,q,0,0,F,q,J,r.NEAREST),l===!0&&(A.length=0,$e.length=0,A.push(r.COLOR_ATTACHMENT0+ce),E.depthBuffer&&E.resolveDepthBuffer===!1&&(A.push(Y),$e.push(Y),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,$e)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,A))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),ae)for(let ce=0;ce<g.length;ce++){t.bindFramebuffer(r.FRAMEBUFFER,ve.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ce,r.RENDERBUFFER,ve.__webglColorRenderbuffer[ce]);const Ce=i.get(g[ce]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,ve.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+ce,r.TEXTURE_2D,Ce,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,ve.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&l){const g=E.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[g])}}}function Ge(E){return Math.min(n.maxSamples,E.samples)}function ge(E){const g=i.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Qe(E){const g=o.render.frame;u.get(E)!==g&&(u.set(E,g),E.update())}function be(E,g){const F=E.colorSpace,q=E.format,J=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||F!==ti&&F!==ei&&(ze.getTransfer(F)===Xe?(q!==Rt||J!==kt)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),g}function Re(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(c.width=E.naturalWidth||E.width,c.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(c.width=E.displayWidth,c.height=E.displayHeight):(c.width=E.width,c.height=E.height),c}this.allocateTextureUnit=H,this.resetTextureUnits=C,this.setTexture2D=j,this.setTexture2DArray=Z,this.setTexture3D=W,this.setTextureCube=X,this.rebindTextures=we,this.setupRenderTarget=Ie,this.updateRenderTargetMipmap=Ke,this.updateMultisampleRenderTarget=He,this.setupDepthRenderbuffer=ye,this.setupFrameBufferTexture=Q,this.useMultisampledRTT=ge}function Fp(r,e){function t(i,n=ei){let a;const o=ze.getTransfer(n);if(i===kt)return r.UNSIGNED_BYTE;if(i===Rn)return r.UNSIGNED_SHORT_4_4_4_4;if(i===Cn)return r.UNSIGNED_SHORT_5_5_5_1;if(i===as)return r.UNSIGNED_INT_5_9_9_9_REV;if(i===rs)return r.BYTE;if(i===ns)return r.SHORT;if(i===rr)return r.UNSIGNED_SHORT;if(i===wn)return r.INT;if(i===mi)return r.UNSIGNED_INT;if(i===Gt)return r.FLOAT;if(i===nr)return r.HALF_FLOAT;if(i===ss)return r.ALPHA;if(i===os)return r.RGB;if(i===Rt)return r.RGBA;if(i===ls)return r.LUMINANCE;if(i===cs)return r.LUMINANCE_ALPHA;if(i===Li)return r.DEPTH_COMPONENT;if(i===Ii)return r.DEPTH_STENCIL;if(i===hs)return r.RED;if(i===Pn)return r.RED_INTEGER;if(i===us)return r.RG;if(i===Un)return r.RG_INTEGER;if(i===Ln)return r.RGBA_INTEGER;if(i===wr||i===Rr||i===Cr||i===Pr)if(o===Xe)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===wr)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Rr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Cr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Pr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===wr)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Rr)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Cr)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Pr)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===In||i===Dn||i===Nn||i===On)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===In)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Dn)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Nn)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===On)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Fn||i===Bn||i===zn)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(i===Fn||i===Bn)return o===Xe?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===zn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Hn||i===Vn||i===kn||i===Gn||i===Wn||i===Xn||i===jn||i===qn||i===Yn||i===Kn||i===Zn||i===Jn||i===$n||i===Qn)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(i===Hn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Vn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===kn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Gn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Wn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Xn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===jn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===qn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Yn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Kn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Zn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Jn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===$n)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Qn)return o===Xe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Ur||i===ea||i===ta)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(i===Ur)return o===Xe?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===ea)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===ta)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===ds||i===ia||i===ra||i===na)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(i===Ur)return a.COMPRESSED_RED_RGTC1_EXT;if(i===ia)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===ra)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===na)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Ui?r.UNSIGNED_INT_24_8:r[i]!==void 0?r[i]:null}return{convert:t}}class Bp extends St{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class ln extends ut{constructor(){super(),this.isGroup=!0,this.type="Group"}}const zp={type:"move"};class Ba{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ln,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ln,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new I,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new I),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ln,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new I,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new I),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let n=null,a=null,o=null;const s=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const x of e.hand.values()){const d=t.getJointPose(x,i),h=this._getHandJoint(c,x);d!==null&&(h.matrix.fromArray(d.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=d.radius),h.visible=d!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],p=u.position.distanceTo(f.position),m=.02,v=.005;c.inputState.pinching&&p>m+v?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&p<=m-v&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(a=t.getPose(e.gripSpace,i),a!==null&&(l.matrix.fromArray(a.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,a.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(a.linearVelocity)):l.hasLinearVelocity=!1,a.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(a.angularVelocity)):l.hasAngularVelocity=!1));s!==null&&(n=t.getPose(e.targetRaySpace,i),n===null&&a!==null&&(n=a),n!==null&&(s.matrix.fromArray(n.transform.matrix),s.matrix.decompose(s.position,s.rotation,s.scale),s.matrixWorldNeedsUpdate=!0,n.linearVelocity?(s.hasLinearVelocity=!0,s.linearVelocity.copy(n.linearVelocity)):s.hasLinearVelocity=!1,n.angularVelocity?(s.hasAngularVelocity=!0,s.angularVelocity.copy(n.angularVelocity)):s.hasAngularVelocity=!1,this.dispatchEvent(zp)))}return s!==null&&(s.visible=n!==null),l!==null&&(l.visible=a!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new ln;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}const Hp=`
void main() {
...
}`;class kp{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,i){if(this.texture===null){const n=new _t,a=e.properties.get(n);a.__webglTexture=t.texture,(t.depthNear!=i.depthNear||t.depthFar!=i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new oi({vertexShader:Hp,fragmentShader:Vp,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new bt(new fn(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Gp extends Ni{constructor(e,t){super();const i=this;let n=null,a=1,o=null,s="local-floor",l=1,c=null,u=null,f=null,p=null,m=null,v=null;const x=new kp,d=t.getContextAttributes();let h=null,T=null;const y=[],b=[],B=new Ne;let w=null;const R=new St;R.layers.enable(1),R.viewport=new je;const N=new St;N.layers.enable(2),N.viewport=new je;const S=[R,N],M=new Bp;M.layers.enable(1),M.layers.enable(2);let C=null,H=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(G){let Q=y[G];return Q===void 0&&(Q=new Ba,y[G]=Q),Q.getTargetRaySpace()},this.getControllerGrip=function(G){let Q=y[G];return Q===void 0&&(Q=new Ba,y[G]=Q),Q.getGripSpace()},this.getHand=function(G){let Q=y[G];return Q===void 0&&(Q=new Ba,y[G]=Q),Q.getHandSpace()};function z(G){const Q=b.indexOf(G.inputSource);if(Q===-1)return;const de=y[Q];de!==void 0&&(de.update(G.inputSource,G.frame,c||o),de.dispatchEvent({type:G.type,data:G.inputSource}))}function j(){n.removeEventListener("select",z),n.removeEventListener("selectstart",z),n.removeEventListener("selectend",z),n.removeEventListener("squeeze",z),n.removeEventListener("squeezestart",z),n.removeEventListener("squeezeend",z),n.removeEventListener("end",j),n.removeEventListener("inputsourceschange",Z);for(let G=0;G<y.length;G++){const Q=b[G];Q!==null&&(b[G]=null,y[G].disconnect(Q))}C=null,H=null,x.reset(),e.setRenderTarget(h),m=null,p=null,f=null,n=null,T=null,ke.stop(),i.isPresenting=!1,e.setPixelRatio(w),e.setSize(B.width,B.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(G){a=G,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(G){s=G,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(G){c=G},this.getBaseLayer=function(){return p!==null?p:m},this.getBinding=function(){return f},this.getFrame=function(){return v},this.getSession=function(){return n},this.setSession=async function(G){if(n=G,n!==null){if(h=e.getRenderTarget(),n.addEventListener("select",z),n.addEventListener("selectstart",z),n.addEventListener("selectend",z),n.addEventListener("squeeze",z),n.addEventListener("squeezestart",z),n.addEventListener("squeezeend",z),n.addEventListener("end",j),n.addEventListener("inputsourceschange",Z),d.xrCompatible!==!0&&await t.makeXRCompatible(),w=e.getPixelRatio(),e.getSize(B),n.renderState.layers===void 0){const Q={antialias:d.antialias,alpha:!0,depth:d.depth,stencil:d.stencil,framebufferScaleFactor:a};m=new XRWebGLLayer(n,t,Q),n.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),T=new gi(m.framebufferWidth,m.framebufferHeight,{format:Rt,type:kt,colorSpace:e.outputColorSpace,stencilBuffer:d.stencil})}else{let Q=null,de=null,oe=null;d.depth&&(oe=d.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,Q=d.stencil?Ii:Li,de=d.stencil?Ui:mi);const ye={colorFormat:t.RGBA8,depthFormat:oe,scaleFactor:a};f=new XRWebGLBinding(n,t),p=f.createProjectionLayer(ye),n.updateRenderState({layers:[p]}),e.setPixelRatio(1),e.setSize(p.textureWidth,p.textureHeight,!1),T=new gi(p.textureWidth,p.textureHeight,{format:Rt,type:kt,depthTexture:new io(p.textureWidth,p.textureHeight,de,void 0,void 0,void 0,void 0,void 0,void 0,Q),stencilBuffer:d.stencil,colorSpace:e.outputColorSpace,samples:d.antialias?4:0,resolveDepthBuffer:p.ignoreDepthValues===!1})}T.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await n.requestReferenceSpace(s),ke.setContext(n),ke.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(n!==null)return n.environmentBlendMode},this.getDepthTexture=function(){return x.getDepthTexture()};function Z(G){for(let Q=0;Q<G.removed.length;Q++){const de=G.removed[Q],oe=b.indexOf(de);oe>=0&&(b[oe]=null,y[oe].disconnect(de))}for(let Q=0;Q<G.added.length;Q++){const de=G.added[Q];let oe=b.indexOf(de);if(oe===-1){for(let we=0;we<y.length;we++)if(we>=b.length){b.push(de),oe=we;break}else if(b[we]===null){b[we]=de,oe=we;break}if(oe===-1)break}const ye=y[oe];ye&&ye.connect(de)}}const W=new I,X=new I;function V(G,Q,de){W.setFromMatrixPosition(Q.matrixWorld),X.setFromMatrixPosition(de.matrixWorld);const oe=W.distanceTo(X),ye=Q.projectionMatrix.elements,we=de.projectionMatrix.elements,Ie=ye[14]/(ye[10]-1),Ke=ye[14]/(ye[10]+1),A=(ye[9]+1)/ye[5],$e=(ye[9]-1)/ye[5],He=(ye[8]-1)/ye[0],Ge=(we[8]+1)/we[0],ge=Ie*He,Qe=Ie*Ge,be=oe/(-He+Ge),Re=be*-He;if(Q.matrixWorld.decompose(G.position,G.quaternion,G.scale),G.translateX(Re),G.translateZ(be),G.matrixWorld.compose(G.position,G.quaternion,G.scale),G.matrixWorldInverse.copy(G.matrixWorld).invert(),ye[10]===-1)G.projectionMatrix.copy(Q.projectionMatrix),G.projectionMatrixInverse.copy(Q.projectionMatrixInverse);else{const E=Ie+be,g=Ke+be,F=ge-Re,q=Qe+(oe-Re),J=A*Ke/g*E,Y=$e*Ke/g*E;G.projectionMatrix.makePerspective(F,q,J,Y,E,g),G.projectionMatrixInverse.copy(G.projectionMatrix).invert()}}function re(G,Q){Q===null?G.matrixWorld.copy(G.matrix):G.matrixWorld.multiplyMatrices(Q.matrixWorld,G.matrix),G.matrixWorldInverse.copy(G.matrixWorld).invert()}this.updateCamera=function(G){if(n===null)return;let Q=G.near,de=G.far;x.texture!==null&&(x.depthNear>0&&(Q=x.depthNear),x.depthFar>0&&(de=x.depthFar)),M.near=N.near=R.near=Q,M.far=N.far=R.far=de,(C!==M.near||H!==M.far)&&(n.updateRenderState({depthNear:M.near,depthFar:M.far}),C=M.near,H=M.far);const oe=G.parent,ye=M.cameras;re(M,oe);for(let we=0;we<ye.length;we++)re(ye[we],oe);ye.length===2?V(M,R,N):M.projectionMatrix.copy(R.projectionMatrix),fe(G,M,oe)};function fe(G,Q,de){de===null?G.matrix.copy(Q.matrixWorld):(G.matrix.copy(de.matrixWorld),G.matrix.invert(),G.matrix.multiply(Q.matrixWorld)),G.matrix.decompose(G.position,G.quaternion,G.scale),G.updateMatrixWorld(!0),G.projectionMatrix.copy(Q.projectionMatrix),G.projectionMatrixInverse.copy(Q.projectionMatrixInverse),G.isPerspectiveCamera&&(G.fov=oa*2*Math.atan(1/G.projectionMatrix.elements[5]),G.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(p===null&&m===null))return l},this.setFoveation=function(G){l=G,p!==null&&(p.fixedFoveation=G),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=G)},this.hasDepthSensing=function(){return x.texture!==null},this.getDepthSensingMesh=function(){return x.getMesh(M)};let Se=null;function Oe(G,Q){if(u=Q.getViewerPose(c||o),v=Q,u!==null){const de=u.views;m!==null&&(e.setRenderTargetFramebuffer(T,m.framebuffer),e.setRenderTarget(T));let oe=!1;de.length!==M.cameras.length&&(M.cameras.length=0,oe=!0);for(let we=0;we<de.length;we++){const Ie=de[we];let Ke=null;if(m!==null)Ke=m.getViewport(Ie);else{const $e=f.getViewSubImage(p,Ie);Ke=$e.viewport,we===0&&(e.setRenderTargetTextures(T,$e.colorTexture,p.ignoreDepthValues?void 0:$e.depthStencilTexture),e.setRenderTarget(T))}let A=S[we];A===void 0&&(A=new St,A.layers.enable(we),A.viewport=new je,S[we]=A),A.matrix.fromArray(Ie.transform.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale),A.projectionMatrix.fromArray(Ie.projectionMatrix),A.projectionMatrixInverse.copy(A.projectionMatrix).invert(),A.viewport.set(Ke.x,Ke.y,Ke.width,Ke.height),we===0&&(M.matrix.copy(A.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),oe===!0&&M.cameras.push(A)}const ye=n.enabledFeatures;if(ye&&ye.includes("depth-sensing")){const we=f.getDepthInformation(de[0]);we&&we.isValid&&we.texture&&x.init(e,we,n.renderState)}}for(let de=0;de<y.length;de++){const oe=b[de],ye=y[de];oe!==null&&ye!==void 0&&ye.update(oe,Q,c||o)}Se&&Se(G,Q),Q.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:Q}),v=null}const ke=new qs;ke.setAnimationLoop(Oe),this.setAnimationLoop=function(G){Se=G},this.dispose=function(){}}}const bi=new Ft,Wp=new Ze;function Xp(r,e){function t(d,h){d.matrixAutoUpdate===!0&&d.updateMatrix(),h.value.copy(d.matrix)}function i(d,h){h.color.getRGB(d.fogColor.value,ks(r)),h.isFog?(d.fogNear.value=h.near,d.fogFar.value=h.far):h.isFogExp2&&(d.fogDensity.value=h.density)}function n(d,h,T,y,b){h.isMeshBasicMaterial||h.isMeshLambertMaterial?a(d,h):h.isMeshToonMaterial?(a(d,h),f(d,h)):h.isMeshPhongMaterial?(a(d,h),u(d,h)):h.isMeshStandardMaterial?(a(d,h),p(d,h),h.isMeshPhysicalMaterial&&m(d,h,b)):h.isMeshMatcapMaterial?(a(d,h),v(d,h)):h.isMeshDepthMaterial?a(d,h):h.isMeshDistanceMaterial?(a(d,h),x(d,h)):h.isMeshNormalMaterial?a(d,h):h.isLineBasicMaterial?(o(d,h),h.isLineDashedMaterial&&s(d,h)):h.isPointsMaterial?l(d,h,T,y):h.isSpriteMaterial?c(d,h):h.isShadowMaterial?(d.color.value.copy(h.color),d.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function a(d,h){d.opacity.value=h.opacity,h.color&&d.diffuse.value.copy(h.color),h.emissive&&d.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(d.map.value=h.map,t(h.map,d.mapTransform)),h.alphaMap&&(d.alphaMap.value=h.alphaMap,t(h.alphaMap,d.alphaMapTransform)),h.bumpMap&&(d.bumpMap.value=h.bumpMap,t(h.bumpMap,d.bumpMapTransform),d.bumpScale.value=h.bumpScale,h.side===mt&&(d.bumpScale.value*=-1)),h.normalMap&&(d.normalMap.value=h.normalMap,t(h.normalMap,d.normalMapTransform),d.normalScale.value.copy(h.normalScale),h.side===mt&&d.normalScale.value.negate()),h.displacementMap&&(d.displacementMap.value=h.displacementMap,t(h.displacementMap,d.displacementMapTransform),d.displacementScale.value=h.displacementScale,d.displacementBias.value=h.displacementBias),h.emissiveMap&&(d.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,d.emissiveMapTransform)),h.specularMap&&(d.specularMap.value=h.specularMap,t(h.specularMap,d.specularMapTransform)),h.alphaTest>0&&(d.alphaTest.value=h.alphaTest);const T=e.get(h),y=T.envMap,b=T.envMapRotation;y&&(d.envMap.value=y,bi.copy(b),bi.x*=-1,bi.y*=-1,bi.z*=-1,y.isCubeTexture&&y.isRenderTargetTexture===!1&&(bi.y*=-1,bi.z*=-1),d.envMapRotation.value.setFromMatrix4(Wp.makeRotationFromEuler(bi)),d.flipEnvMap.value=y.isCubeTexture&&y.isRenderTargetTexture===!1?-1:1,d.reflectivity.value=h.reflectivity,d.ior.value=h.ior,d.refractionRatio.value=h.refractionRatio),h.lightMap&&(d.lightMap.value=h.lightMap,d.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,d.lightMapTransform)),h.aoMap&&(d.aoMap.value=h.aoMap,d.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,d.aoMapTransform))}function o(d,h){d.diffuse.value.copy(h.color),d.opacity.value=h.opacity,h.map&&(d.map.value=h.map,t(h.map,d.mapTransform))}function s(d,h){d.dashSize.value=h.dashSize,d.totalSize.value=h.dashSize+h.gapSize,d.scale.value=h.scale}function l(d,h,T,y){d.diffuse.value.copy(h.color),d.opacity.value=h.opacity,d.size.value=h.size*T,d.scale.value=y*.5,h.map&&(d.map.value=h.map,t(h.map,d.uvTransform)),h.alphaMap&&(d.alphaMap.value=h.alphaMap,t(h.alphaMap,d.alphaMapTransform)),h.alphaTest>0&&(d.alphaTest.value=h.alphaTest)}function c(d,h){d.diffuse.value.copy(h.color),d.opacity.value=h.opacity,d.rotation.value=h.rotation,h.map&&(d.map.value=h.map,t(h.map,d.mapTransform)),h.alphaMap&&(d.alphaMap.value=h.alphaMap,t(h.alphaMap,d.alphaMapTransform)),h.alphaTest>0&&(d.alphaTest.value=h.alphaTest)}function u(d,h){d.specular.value.copy(h.specular),d.shininess.value=Math.max(h.shininess,1e-4)}function f(d,h){h.gradientMap&&(d.gradientMap.value=h.gradientMap)}function p(d,h){d.metalness.value=h.metalness,h.metalnessMap&&(d.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,d.metalnessMapTransform)),d.roughness.value=h.roughness,h.roughnessMap&&(d.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,d.roughnessMapTransform)),h.envMap&&(d.envMapIntensity.value=h.envMapIntensity)}function m(d,h,T){d.ior.value=h.ior,h.sheen>0&&(d.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),d.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(d.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,d.sheenColorMapTransform)),h.sheenRoughnessMap&&(d.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,d.sheenRoughnessMapTransform))),h.clearcoat>0&&(d.clearcoat.value=h.clearcoat,d.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(d.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,d.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(d.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,d.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(d.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,d.clearcoatNormalMapTransform),d.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===mt&&d.clearcoatNormalScale.value.negate())),h.dispersion>0&&(d.dispersion.value=h.dispersion),h.iridescence>0&&(d.iridescence.value=h.iridescence,d.iridescenceIOR.value=h.iridescenceIOR,d.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],d.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(d.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,d.iridescenceMapTransform)),h.iridescenceThicknessMap&&(d.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,d.iridescenceThicknessMapTransform))),h.transmission>0&&(d.transmission.value=h.transmission,d.transmissionSamplerMap.value=T.texture,d.transmissionSamplerSize.value.set(T.width,T.height),h.transmissionMap&&(d.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,d.transmissionMapTransform)),d.thickness.value=h.thickness,h.thicknessMap&&(d.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,d.thicknessMapTransform)),d.attenuationDistance.value=h.attenuationDistance,d.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(d.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(d.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,d.anisotropyMapTransform))),d.specularIntensity.value=h.specularIntensity,d.specularColor.value.copy(h.specularColor),h.specularColorMap&&(d.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,d.specularColorMapTransform)),h.specularIntensityMap&&(d.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,d.specularIntensityMapTransform))}function v(d,h){h.matcap&&(d.matcap.value=h.matcap)}function x(d,h){const T=e.get(h).light;d.referencePosition.value.setFromMatrixPosition(T.matrixWorld),d.nearDistance.value=T.shadow.camera.near,d.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:n}}function jp(r,e,t,i){let n={},a={},o=[];const s=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function l(T,y){const b=y.program;i.uniformBlockBinding(T,b)}function c(T,y){let b=n[T.id];b===void 0&&(v(T),b=u(T),n[T.id]=b,T.addEventListener("dispose",d));const B=y.program;i.updateUBOMapping(T,B);const w=e.render.frame;a[T.id]!==w&&(p(T),a[T.id]=w)}function u(T){const y=f();T.__bindingPointIndex=y;const b=r.createBuffer(),B=T.__size,w=T.usage;return r.bindBuffer(r.UNIFORM_BUFFER,b),r.bufferData(r.UNIFORM_BUFFER,B,w),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,y,b),b}function f(){for(let T=0;T<s;T++)if(o.indexOf(T)===-1)return o.push(T),T;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function p(T){const y=n[T.id],b=T.uniforms,B=T.__cache;r.bindBuffer(r.UNIFORM_BUFFER,y);for(let w=0,R=b.length;w<R;w++){const N=Array.isArray(b[w])?b[w]:[b[w]];for(let S=0,M=N.length;S<M;S++){const C=N[S];if(m(C,w,S,B)===!0){const H=C.__offset,z=Array.isArray(C.value)?C.value:[C.value];let j=0;for(let Z=0;Z<z.length;Z++){const W=z[Z],X=x(W);typeof W=="number"||typeof W=="boolean"?(C.__data[0]=W,r.bufferSubData(r.UNIFORM_BUFFER,H+j,C.__data)):W.isMatrix3?(C.__data[0]=W.elements[0],C.__data[1]=W.elements[1],C.__data[2]=W.elements[2],C.__data[3]=0,C.__data[4]=W.elements[3],C.__data[5]=W.elements[4],C.__data[6]=W.elements[5],C.__data[7]=0,C.__data[8]=W.elements[6],C.__data[9]=W.elements[7],C.__data[10]=W.elements[8],C.__data[11]=0):(W.toArray(C.__data,j),j+=X.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,H,C.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function m(T,y,b,B){const w=T.value,R=y+"_"+b;if(B[R]===void 0)return typeof w=="number"||typeof w=="boolean"?B[R]=w:B[R]=w.clone(),!0;{const N=B[R];if(typeof w=="number"||typeof w=="boolean"){if(N!==w)return B[R]=w,!0}else if(N.equals(w)===!1)return N.copy(w),!0}return!1}function v(T){const y=T.uniforms;let b=0;const B=16;for(let R=0,N=y.length;R<N;R++){const S=Array.isArray(y[R])?y[R]:[y[R]];for(let M=0,C=S.length;M<C;M++){const H=S[M],z=Array.isArray(H.value)?H.value:[H.value];for(let j=0,Z=z.length;j<Z;j++){const W=z[j],X=x(W),V=b%B,re=V%X.boundary,fe=V+re;b+=re,fe!==0&&B-fe<X.storage&&(b+=B-fe),H.__data=new Float32Array(X.storage/Float32Array.BYTES_PER_ELEMENT),H.__offset=b,b+=X.storage}}}const w=b%B;return w>0&&(b+=B-w),T.__size=b,T.__cache={},this}function x(T){const y={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(y.boundary=4,y.storage=4):T.isVector2?(y.boundary=8,y.storage=8):T.isVector3||T.isColor?(y.boundary=16,y.storage=12):T.isVector4?(y.boundary=16,y.storage=16):T.isMatrix3?(y.boundary=48,y.storage=48):T.isMatrix4?(y.boundary=64,y.storage=64):T.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",T),y}function d(T){const y=T.target;y.removeEventListener("dispose",d);const b=o.indexOf(y.__bindingPointIndex);o.splice(b,1),r.deleteBuffer(n[y.id]),delete n[y.id],delete a[y.id]}function h(){for(const T in n)r.deleteBuffer(n[T]);o=[],n={},a={}}return{bind:l,update:c,dispose:h}}class qp{constructor(e={}){const{canvas:t=Ol(),context:i=null,depth:n=!0,stencil:a=!1,alpha:o=!1,antialias:s=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1}=e;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=o;const m=new Uint32Array(4),v=new Int32Array(4);let x=null,d=null;const h=[],T=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=It,this.toneMapping=Qt,this.toneMappingExposure=1;const y=this;let b=!1,B=0,w=0,R=null,N=-1,S=null;const M=new je,C=new je;let H=null;const z=new De(0);let j=0,Z=t.width,W=t.height,X=1,V=null,re=null;const fe=new je(0,0,Z,W),Se=new je(0,0,Z,W);let Oe=!1;const ke=new Ca;let G=!1,Q=!1;const de=new Ze,oe=new I,ye=new je,we={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ie=!1;function Ke(){return R===null?X:1}let A=i;function $e(_,U){return t.getContext(_,U)}try{const _={alpha:!0,depth:n,stencil:a,antialias:s,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${xn}`),t.addEventListener("webglcontextlost",k,!1),t.addEventListener("webglcontextrestored",K,!1),t.addEventListener("webglcontextcreationerror",ie,!1),A===null){const U="webgl2";if(A=$e(U,_),A===null)throw $e(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(_){throw console.error("THREE.WebGLRenderer: "+_.message),_}let He,Ge,ge,Qe,be,Re,E,g,F,q,J,Y,ve,ae,ce,Ce,ee,he,Fe,Te,le,Ae,Le,Ye;function P(){He=new Qu(A),He.init(),Ae=new Fp(A,He),Ge=new qu(A,He,e,Ae),ge=new Dp(A),Qe=new id(A),be=new Mp,Re=new Op(A,He,ge,be,Ge,Ae,Qe),E=new Ku(y),g=new $u(y),F=new cc(A),Le=new Xu(A,F),q=new ed(A,F,Qe,Le),J=new nd(A,q,F,Qe),Fe=new rd(A,Ge,Re),Ce=new Yu(be),Y=new xp(y,E,g,He,Ge,Le,Ce),ve=new Xp(y,be),ae=new yp,ce=new Rp(He),he=new Wu(y,E,g,ge,J,p,l),ee=new Ip(y,J,Ge),Ye=new jp(A,Qe,Ge,ge),Te=new ju(A,He,Qe),le=new td(A,He,Qe),Qe.programs=Y.programs,y.capabilities=Ge,y.extensions=He,y.properties=be,y.renderLists=ae,y.shadowMap=ee,y.state=ge,y.info=Qe}P();const te=new Gp(y,A);this.xr=te,this.getContext=function(){return A},this.getContextAttributes=function(){return A.getContextAttributes()},this.forceContextLoss=function(){const _=He.get("WEBGL_lose_context");_&&_.loseContext()},this.forceContextRestore=function(){const _=He.get("WEBGL_lose_context");_&&_.restoreContext()},this.getPixelRatio=function(){return X},this.setPixelRatio=function(_){_!==void 0&&(X=_,this.setSize(Z,W,!1))},this.getSize=function(_){return _.set(Z,W)},this.setSize=function(_,U,D=!0){if(te.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Z=_,W=U,t.width=Math.floor(_*X),t.height=Math.floor(U*X),D===!0&&(t.style.width=_+"px",t.style.height=U+"px"),this.setViewport(0,0,_,U)},this.getDrawingBufferSize=function(_){return _.set(Z*X,W*X).floor()},this.setDrawingBufferSize=function(_,U,D){Z=_,W=U,X=D,t.width=Math.floor(_*D),t.height=Math.floor(U*D),this.setViewport(0,0,_,U)},this.getCurrentViewport=function(_){return _.copy(M)},this.getViewport=function(_){return _.copy(fe)},this.setViewport=function(_,U,D,O){_.isVector4?fe.set(_.x,_.y,_.z,_.w):fe.set(_,U,D,O),ge.viewport(M.copy(fe).multiplyScalar(X).round())},this.getScissor=function(_){return _.copy(Se)},this.setScissor=function(_,U,D,O){_.isVector4?Se.set(_.x,_.y,_.z,_.w):Se.set(_,U,D,O),ge.scissor(C.copy(Se).multiplyScalar(X).round())},this.getScissorTest=function(){return Oe},this.setScissorTest=function(_){ge.setScissorTest(Oe=_)},this.setOpaqueSort=function(_){V=_},this.setTransparentSort=function(_){re=_},this.getClearColor=function(_){return _.copy(he.getClearColor())},this.setClearColor=function(){he.setClearColor.apply(he,arguments)},this.getClearAlpha=function(){return he.getClearAlpha()},this.setClearAlpha=function(){he.setClearAlpha.apply(he,arguments)},this.clear=function(_=!0,U=!0,D=!0){let O=0;if(_){let L=!1;if(R!==null){const $=R.texture.format;L=$===Ln||$===Un||$===Pn}if(L){const $=R.texture.type,se=$===kt||$===mi||$===rr||$===Ui||$===Rn||$===Cn,ue=he.getClearColor(),pe=he.getClearAlpha(),Ee=ue.r,Me=ue.g,xe=ue.b;se?(m[0]=Ee,m[1]=Me,m[2]=xe,m[3]=pe,A.clearBufferuiv(A.COLOR,0,m)):(v[0]=Ee,v[1]=Me,v[2]=xe,v[3]=pe,A.clearBufferiv(A.COLOR,0,v))}else O|=A.COLOR_BUFFER_BIT}U&&(O|=A.DEPTH_BUFFER_BIT),D&&(O|=A.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),A.clear(O)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",k,!1),t.removeEventListener("webglcontextrestored",K,!1),t.removeEventListener("webglcontextcreationerror",ie,!1),ae.dispose(),ce.dispose(),be.dispose(),E.dispose(),g.dispose(),J.dispose(),Le.dispose(),Ye.dispose(),Y.dispose(),te.dispose(),te.removeEventListener("sessionstart",Lt),te.removeEventListener("sessionend",Ga),hi.stop()};function k(_){_.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),b=!0}function K(){console.log("THREE.WebGLRenderer: Context Restored."),b=!1;const _=Qe.autoReset,U=ee.enabled,D=ee.autoUpdate,O=ee.needsUpdate,L=ee.type;P(),Qe.autoReset=_,ee.enabled=U,ee.autoUpdate=D,ee.needsUpdate=O,ee.type=L}function ie(_){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",_.statusMessage)}function _e(_){const U=_.target;U.removeEventListener("dispose",_e),We(U)}function We(_){et(_),be.remove(_)}function et(_){const U=be.get(_).programs;U!==void 0&&(U.forEach(function(D){Y.releaseProgram(D)}),_.isShaderMaterial&&Y.releaseShaderCache(_))}this.renderBufferDirect=function(_,U,D,O,L,$){U===null&&(U=we);const se=L.isMesh&&L.matrixWorld.determinant()<0,ue=Fo(_,U,D,O,L);ge.setMaterial(O,se);let pe=D.index,Ee=1;if(O.wireframe===!0){if(pe=q.getWireframeAttribute(D),pe===void 0)return;Ee=2}const Me=D.drawRange,xe=D.attributes.position;let Ve=Me.start*Ee,tt=(Me.start+Me.count)*Ee;$!==null&&(Ve=Math.max(Ve,$.start*Ee),tt=Math.min(tt,($.start+$.count)*Ee)),pe!==null?(Ve=Math.max(Ve,0),tt=Math.min(tt,pe.count)):xe!=null&&(Ve=Math.max(Ve,0),tt=Math.min(tt,xe.count));const Je=tt-Ve;if(Je<0||Je===1/0)return;Le.setup(L,O,ue,D,pe);let nt,qe=Te;if(pe!==null&&(nt=F.get(pe),qe=le,qe.setIndex(nt)),L.isMesh)O.wireframe===!0?(ge.setLineWidth(O.wireframeLinewidth*Ke()),qe.setMode(A.LINES)):qe.setMode(A.TRIANGLES);else if(L.isLine){let me=O.linewidth;me===void 0&&(me=1),ge.setLineWidth(me*Ke()),L.isLineSegments?qe.setMode(A.LINES):L.isLineLoop?qe.setMode(A.LINE_LOOP):qe.setMode(A.LINE_STRIP)}else L.isPoints?qe.setMode(A.POINTS):L.isSprite&&qe.setMode(A.TRIANGLES);if(L.isBatchedMesh)if(L._multiDrawInstances!==null)qe.renderMultiDrawInstances(L._multiDrawStarts,L._multiDrawCounts,L._multiDrawCount,L._multiDrawInstances);else if(He.get("WEBGL_multi_draw"))qe.renderMultiDraw(L._multiDrawStarts,L._multiDrawCounts,L._multiDrawCount);else{const me=L._multiDrawStarts,dt=L._multiDrawCounts,ui=L._multiDrawCount,At=pe?F.get(pe).bytesPerElement:1,wi=be.get(O).currentProgram.getUniforms();for(let vt=0;vt<ui;vt++)wi.setValue(A,"_gl_DrawID",vt),qe.render(me[vt]/At,dt[vt])}else if(L.isInstancedMesh)qe.renderInstances(Ve,Je,L.count);else if(D.isInstancedBufferGeometry){const me=D._maxInstanceCount!==void 0?D._maxInstanceCount:1/0,dt=Math.min(D.instanceCount,me);qe.renderInstances(Ve,Je,dt)}else qe.render(Ve,Je)};function lt(_,U,D){_.transparent===!0&&_.side===Vt&&_.forceSinglePass===!1?(_.side=mt,_.needsUpdate=!0,Er(_,U,D),_.side=Jt,_.needsUpdate=!0,Er(_,U,D),_.side=Vt):Er(_,U,D)}this.compile=function(_,U,D=null){D===null&&(D=_),d=ce.get(D),d.init(U),T.push(d),D.traverseVisible(function(L){L.isLight&&L.layers.test(U.layers)&&(d.pushLight(L),L.castShadow&&d.pushShadow(L))}),_!==D&&_.traverseVisible(function(L){L.isLight&&L.layers.test(U.layers)&&(d.pushLight(L),L.castShadow&&d.pushShadow(L))}),d.setupLights();const O=new Set;return _.traverse(function(L){const $=L.material;if($)if(Array.isArray($))for(let se=0;se<$.length;se++){const ue=$[se];lt(ue,D,L),O.add(ue)}else lt($,D,L),O.add($)}),T.pop(),d=null,O},this.compileAsync=function(_,U,D=null){const O=this.compile(_,U,D);return new Promise(L=>{function $(){if(O.forEach(function(se){be.get(se).currentProgram.isReady()&&O.delete(se)}),O.size===0){L(_);return}setTimeout($,10)}He.get("KHR_parallel_shader_compile")!==null?$():setTimeout($,10)})};let Be=null;function zt(_){Be&&Be(_)}function Lt(){hi.stop()}function Ga(){hi.start()}const hi=new qs;hi.setAnimationLoop(zt),typeof self<"u"&&hi.setContext(self),this.setAnimationLoop=function(_){Be=_,te.setAnimationLoop(_),_===null?hi.stop():hi.start()},te.addEventListener("sessionstart",Lt),te.addEventListener("sessionend",Ga),this.render=function(_,U){if(U!==void 0&&U.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(b===!0)return;if(_.matrixWorldAutoUpdate===!0&&_.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),te.enabled===!0&&te.isPresenting===!0&&(te.cameraAutoUpdate===!0&&te.updateCamera(U),U=te.getCamera()),_.isScene===!0&&_.onBeforeRender(y,_,U,R),d=ce.get(_,T.length),d.init(U),T.push(d),de.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),ke.setFromProjectionMatrix(de),Q=this.localClippingEnabled,G=Ce.init(this.clippingPlanes,Q),x=ae.get(_,h.length),x.init(),h.push(x),te.enabled===!0&&te.isPresenting===!0){const $=y.xr.getDepthSensingMesh();$!==null&&mn($,U,-1/0,y.sortObjects)}mn(_,U,0,y.sortObjects),x.finish(),y.sortObjects===!0&&x.sort(V,re),Ie=te.enabled===!1||te.isPresenting===!1||te.hasDepthSensing()===!1,Ie&&he.addToRenderList(x,_),this.info.render.frame++,G===!0&&Ce.beginShadows();const D=d.state.shadowsArray;ee.render(D,_,U),G===!0&&Ce.endShadows(),this.info.autoReset===!0&&this.info.reset();const O=x.opaque,L=x.transmissive;if(d.setupLights(),U.isArrayCamera){const $=U.cameras;if(L.length>0)for(let se=0,ue=$.length;se<ue;se++){const pe=$[se];Xa(O,L,_,pe)}Ie&&he.render(_);for(let se=0,ue=$.length;se<ue;se++){const pe=$[se];Wa(x,_,pe,pe.viewport)}}else L.length>0&&Xa(O,L,_,U),Ie&&he.render(_),Wa(x,_,U);R!==null&&(Re.updateMultisampleRenderTarget(R),Re.updateRenderTargetMipmap(R)),_.isScene===!0&&_.onAfterRender(y,_,U),Le.resetDefaultState(),N=-1,S=null,T.pop(),T.length>0?(d=T[T.length-1],G===!0&&Ce.setGlobalState(y.clippingPlanes,d.state.camera)):d=null,h.pop(),h.length>0?x=h[h.length-1]:x=null};function mn(_,U,D,O){if(_.visible===!1)return;if(_.layers.test(U.layers)){if(_.isGroup)D=_.renderOrder;else if(_.isLOD)_.autoUpdate===!0&&_.update(U);else if(_.isLight)d.pushLight(_),_.castShadow&&d.pushShadow(_);else if(_.isSprite){if(!_.frustumCulled||ke.intersectsSprite(_)){O&&ye.setFromMatrixPosition(_.matrixWorld).applyMatrix4(de);const $=J.update(_),se=_.material;se.visible&&x.push(_,$,se,D,ye.z,null)}}else if((_.isMesh||_.isLine||_.isPoints)&&(!_.frustumCulled||ke.intersectsObject(_))){const $=J.update(_),se=_.material;if(O&&(_.boundingSphere!==void 0?(_.boundingSphere===null&&_.computeBoundingSphere(),ye.copy(_.boundingSphere.center)):($.boundingSphere===null&&$.computeBoundingSphere(),ye.copy($.boundingSphere.center)),ye.applyMatrix4(_.matrixWorld).applyMatrix4(de)),Array.isArray(se)){const ue=$.groups;for(let pe=0,Ee=ue.length;pe<Ee;pe++){const Me=ue[pe],xe=se[Me.materialIndex];xe&&xe.visible&&x.push(_,$,xe,D,ye.z,Me)}}else se.visible&&x.push(_,$,se,D,ye.z,null)}}const L=_.children;for(let $=0,se=L.length;$<se;$++)mn(L[$],U,D,O)}function Wa(_,U,D,O){const L=_.opaque,$=_.transmissive,se=_.transparent;d.setupLightsView(D),G===!0&&Ce.setGlobalState(y.clippingPlanes,D),O&&ge.viewport(M.copy(O)),L.length>0&&yr(L,U,D),$.length>0&&yr($,U,D),se.length>0&&yr(se,U,D),ge.buffers.depth.setTest(!0),ge.buffers.depth.setMask(!0),ge.buffers.color.setMask(!0),ge.setPolygonOffset(!1)}function Xa(_,U,D,O){if((D.isScene===!0?D.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[O.id]===void 0&&(d.state.transmissionRenderTarget[O.id]=new gi(1,1,{generateMipmaps:!0,type:He.has("EXT_color_buffer_half_float")||He.has("EXT_color_buffer_float")?nr:kt,minFilter:fi,samples:4,stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ze.workingColorSpace}));const L=d.state.transmissionRenderTarget[O.id],$=O.viewport||M;L.setSize($.z,$.w);const se=y.getRenderTarget();y.setRenderTarget(L),y.getClearColor(z),j=y.getClearAlpha(),j<1&&y.setClearColor(16777215,.5),y.clear(),Ie&&he.render(D);const ue=y.toneMapping;y.toneMapping=Qt;const pe=O.viewport;if(O.viewport!==void 0&&(O.viewport=void 0),d.setupLightsView(O),G===!0&&Ce.setGlobalState(y.clippingPlanes,O),yr(_,D,O),Re.updateMultisampleRenderTarget(L),Re.updateRenderTargetMipmap(L),He.has("WEBGL_multisampled_render_to_texture")===!1){let Ee=!1;for(let Me=0,xe=U.length;Me<xe;Me++){const Ve=U[Me],tt=Ve.object,Je=Ve.geometry,nt=Ve.material,qe=Ve.group;if(nt.side===Vt&&tt.layers.test(O.layers)){const me=nt.side;nt.side=mt,nt.needsUpdate=!0,ja(tt,D,O,Je,nt,qe),nt.side=me,nt.needsUpdate=!0,Ee=!0}}Ee===!0&&(Re.updateMultisampleRenderTarget(L),Re.updateRenderTargetMipmap(L))}y.setRenderTarget(se),y.setClearColor(z,j),pe!==void 0&&(O.viewport=pe),y.toneMapping=ue}function yr(_,U,D){const O=U.isScene===!0?U.overrideMaterial:null;for(let L=0,$=_.length;L<$;L++){const se=_[L],ue=se.object,pe=se.geometry,Ee=O===null?se.material:O,Me=se.group;ue.layers.test(D.layers)&&ja(ue,U,D,pe,Ee,Me)}}function ja(_,U,D,O,L,$){_.onBeforeRender(y,U,D,O,L,$),_.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,_.matrixWorld),_.normalMatrix.getNormalMatrix(_.modelViewMatrix),L.onBeforeRender(y,U,D,O,_,$),L.transparent===!0&&L.side===Vt&&L.forceSinglePass===!1?(L.side=mt,L.needsUpdate=!0,y.renderBufferDirect(D,U,O,L,_,$),L.side=Jt,L.needsUpdate=!0,y.renderBufferDirect(D,U,O,L,_,$),L.side=Vt):y.renderBufferDirect(D,U,O,L,_,$),_.onAfterRender(y,U,D,O,L,$)}function Er(_,U,D){U.isScene!==!0&&(U=we);const O=be.get(_),L=d.state.lights,$=d.state.shadowsArray,se=L.state.version,ue=Y.getParameters(_,L.state,$,U,D),pe=Y.getProgramCacheKey(ue);let Ee=O.programs;O.environment=_.isMeshStandardMaterial?U.environment:null,O.fog=U.fog,O.envMap=(_.isMeshStandardMaterial?g:E).get(_.envMap||O.environment),O.envMapRotation=O.environment!==null&&_.envMap===null?U.environmentRotation:_.envMapRotation,Ee===void 0&&(_.addEventListener("dispose",_e),Ee=new Map,O.programs=Ee);let Me=Ee.get(pe);if(Me!==void 0){if(O.currentProgram===Me&&O.lightsStateVersion===se)return Ya(_,ue),Me}else ue.uniforms=Y.getUniforms(_),_.onBeforeCompile(ue,y),Me=Y.acquireProgram(ue,pe),Ee.set(pe,Me),O.uniforms=ue.uniforms;const xe=O.uniforms;return(!_.isShaderMaterial&&!_.isRawShaderMaterial||_.clipping===!0)&&(xe.clippingPlanes=Ce.uniform),Ya(_,ue),O.needsLights=zo(_),O.lightsStateVersion=se,O.needsLights&&(xe.ambientLightColor.value=L.state.ambient,xe.lightProbe.value=L.state.probe,xe.directionalLights.value=L.state.directional,xe.directionalLightShadows.value=L.state.directionalShadow,xe.spotLights.value=L.state.spot,xe.spotLightShadows.value=L.state.spotShadow,xe.rectAreaLights.value=L.state.rectArea,xe.ltc_1.value=L.state.rectAreaLTC1,xe.ltc_2.value=L.state.rectAreaLTC2,xe.pointLights.value=L.state.point,xe.pointLightShadows.value=L.state.pointShadow,xe.hemisphereLights.value=L.state.hemi,xe.directionalShadowMap.value=L.state.directionalShadowMap,xe.directionalShadowMatrix.value=L.state.directionalShadowMatrix,xe.spotShadowMap.value=L.state.spotShadowMap,xe.spotLightMatrix.value=L.state.spotLightMatrix,xe.spotLightMap.value=L.state.spotLightMap,xe.pointShadowMap.value=L.state.pointShadowMap,xe.pointShadowMatrix.value=L.state.pointShadowMatrix),O.currentProgram=Me,O.uniformsList=null,Me}function qa(_){if(_.uniformsList===null){const U=_.currentProgram.getUniforms();_.uniformsList=sn.seqWithValue(U.seq,_.uniforms)}return _.uniformsList}function Ya(_,U){const D=be.get(_);D.outputColorSpace=U.outputColorSpace,D.batching=U.batching,D.batchingColor=U.batchingColor,D.instancing=U.instancing,D.instancingColor=U.instancingColor,D.instancingMorph=U.instancingMorph,D.skinning=U.skinning,D.morphTargets=U.morphTargets,D.morphNormals=U.morphNormals,D.morphColors=U.morphColors,D.morphTargetsCount=U.morphTargetsCount,D.numClippingPlanes=U.numClippingPlanes,D.numIntersection=U.numClipIntersection,D.vertexAlphas=U.vertexAlphas,D.vertexTangents=U.vertexTangents,D.toneMapping=U.toneMapping}function Fo(_,U,D,O,L){U.isScene!==!0&&(U=we),Re.resetTextureUnits();const $=U.fog,se=O.isMeshStandardMaterial?U.environment:null,ue=R===null?y.outputColorSpace:R.isXRRenderTarget===!0?R.texture.colorSpace:ti,pe=(O.isMeshStandardMaterial?g:E).get(O.envMap||se),Ee=O.vertexColors===!0&&!!D.attributes.color&&D.attributes.color.itemSize===4,Me=!!D.attributes.tangent&&(!!O.normalMap||O.anisotropy>0),xe=!!D.morphAttributes.position,Ve=!!D.morphAttributes.normal,tt=!!D.morphAttributes.color;let Je=Qt;O.toneMapped&&(R===null||R.isXRRenderTarget===!0)&&(Je=y.toneMapping);const nt=D.morphAttributes.position||D.morphAttributes.normal||D.morphAttributes.color,qe=nt!==void 0?nt.length:0,me=be.get(O),dt=d.state.lights;if(G===!0&&(Q===!0||_!==S)){const yt=_===S&&O.id===N;Ce.setState(O,_,yt)}let ui=!1;O.version===me.__version?(me.needsLights&&me.lightsStateVersion!==dt.state.version||me.outputColorSpace!==ue||L.isBatchedMesh&&me.batching===!1||!L.isBatchedMesh&&me.batching===!0||L.isBatchedMesh&&me.batchingColor===!0&&L.colorTexture===null||L.isBatchedMesh&&me.batchingColor===!1&&L.colorTexture!==null||L.isInstancedMesh&&me.instancing===!1||!L.isInstancedMesh&&me.instancing===!0||L.isSkinnedMesh&&me.skinning===!1||!L.isSkinnedMesh&&me.skinning===!0||L.isInstancedMesh&&me.instancingColor===!0&&L.instanceColor===null||L.isInstancedMesh&&me.instancingColor===!1&&L.instanceColor!==null||L.isInstancedMesh&&me.instancingMorph===!0&&L.morphTexture===null||L.isInstancedMesh&&me.instancingMorph===!1&&L.morphTexture!==null||me.envMap!==pe||O.fog===!0&&me.fog!==$||me.numClippingPlanes!==void 0&&(me.numClippingPlanes!==Ce.numPlanes||me.numIntersection!==Ce.numIntersection)||me.vertexAlphas!==Ee||me.vertexTangents!==Me||me.morphTargets!==xe||me.morphNormals!==Ve||me.morphColors!==tt||me.toneMapping!==Je||me.morphTargetsCount!==qe)&&(ui=!0):(ui=!0,me.__version=O.version);let At=me.currentProgram;ui===!0&&(At=Er(O,U,L));let wi=!1,vt=!1,gn=!1;const it=At.getUniforms(),Zt=me.uniforms;if(ge.useProgram(At.program)&&(wi=!0,vt=!0,gn=!0),O.id!==N&&(N=O.id,vt=!0),wi||S!==_){it.setValue(A,"projectionMatrix",_.projectionMatrix),it.setValue(A,"viewMatrix",_.matrixWorldInverse);const yt=it.map.cameraPosition;yt!==void 0&&yt.setValue(A,oe.setFromMatrixPosition(_.matrixWorld)),Ge.logarithmicDepthBuffer&&it.setValue(A,"logDepthBufFC",2/(Math.log(_.far+1)/Math.LN2)),(O.isMeshPhongMaterial||O.isMeshToonMaterial||O.isMeshLambertMaterial||O.isMeshBasicMaterial||O.isMeshStandardMaterial||O.isShaderMaterial)&&it.setValue(A,"isOrthographic",_.isOrthographicCamera===!0),S!==_&&(S=_,vt=!0,gn=!0)}if(L.isSkinnedMesh){it.setOptional(A,L,"bindMatrix"),it.setOptional(A,L,"bindMatrixInverse");const yt=L.skeleton;yt&&(yt.boneTexture===null&&yt.computeBoneTexture(),it.setValue(A,"boneTexture",yt.boneTexture,Re))}L.isBatchedMesh&&(it.setOptional(A,L,"batchingTexture"),it.setValue(A,"batchingTexture",L._matricesTexture,Re),it.setOptional(A,L,"batchingIdTexture"),it.setValue(A,"batchingIdTexture",L._indirectTexture,Re),it.setOptional(A,L,"batchingColorTexture"),L._colorsTexture!==null&&it.setValue(A,"batchingColorTexture",L._colorsTexture,Re));const _n=D.morphAttributes;if((_n.position!==void 0||_n.normal!==void 0||_n.color!==void 0)&&Fe.update(L,D,At),(vt||me.receiveShadow!==L.receiveShadow)&&(me.receiveShadow=L.receiveShadow,it.setValue(A,"receiveShadow",L.receiveShadow)),O.isMeshGouraudMaterial&&O.envMap!==null&&(Zt.envMap.value=pe,Zt.flipEnvMap.value=pe.isCubeTexture&&pe.isRenderTargetTexture===!1?-1:1),O.isMeshStandardMaterial&&O.envMap===null&&U.environment!==null&&(Zt.envMapIntensity.value=U.environmentIntensity),vt&&(it.setValue(A,"toneMappingExposure",y.toneMappingExposure),me.needsLights&&Bo(Zt,gn),$&&O.fog===!0&&ve.refreshFogUniforms(Zt,$),ve.refreshMaterialUniforms(Zt,O,X,W,d.state.transmissionRenderTarget[_.id]),sn.upload(A,qa(me),Zt,Re)),O.isShaderMaterial&&O.uniformsNeedUpdate===!0&&(sn.upload(A,qa(me),Zt,Re),O.uniformsNeedUpdate=!1),O.isSpriteMaterial&&it.setValue(A,"center",L.center),it.setValue(A,"modelViewMatrix",L.modelViewMatrix),it.setValue(A,"normalMatrix",L.normalMatrix),it.setValue(A,"modelMatrix",L.matrixWorld),O.isShaderMaterial||O.isRawShaderMaterial){const yt=O.uniformsGroups;for(let vn=0,Ho=yt.length;vn<Ho;vn++){const Ka=yt[vn];Ye.update(Ka,At),Ye.bind(Ka,At)}}return At}function Bo(_,U){_.ambientLightColor.needsUpdate=U,_.lightProbe.needsUpdate=U,_.directionalLights.needsUpdate=U,_.directionalLightShadows.needsUpdate=U,_.pointLights.needsUpdate=U,_.pointLightShadows.needsUpdate=U,_.spotLights.needsUpdate=U,_.spotLightShadows.needsUpdate=U,_.rectAreaLights.needsUpdate=U,_.hemisphereLights.needsUpdate=U}function zo(_){return _.isMeshLambertMaterial||_.isMeshToonMaterial||_.isMeshPhongMaterial||_.isMeshStandardMaterial||_.isShadowMaterial||_.isShaderMaterial&&_.lights===!0}this.getActiveCubeFace=function(){return B},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return R},this.setRenderTargetTextures=function(_,U,D){be.get(_.texture).__webglTexture=U,be.get(_.depthTexture).__webglTexture=D;const O=be.get(_);O.__hasExternalTextures=!0,O.__autoAllocateDepthBuffer=D===void 0,O.__autoAllocateDepthBuffer||He.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),O.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(_,U){const D=be.get(_);D.__webglFramebuffer=U,D.__useDefaultFramebuffer=U===void 0},this.setRenderTarget=function(_,U=0,D=0){R=_,B=U,w=D;let O=!0,L=null,$=!1,se=!1;if(_){const ue=be.get(_);if(ue.__useDefaultFramebuffer!==void 0)ge.bindFramebuffer(A.FRAMEBUFFER,null),O=!1;else if(ue.__webglFramebuffer===void 0)Re.setupRenderTarget(_);else if(ue.__hasExternalTextures)Re.rebindTextures(_,be.get(_.texture).__webglTexture,be.get(_.depthTexture).__webglTexture);else if(_.depthBuffer){const Me=_.depthTexture;if(ue.__boundDepthTexture!==Me){if(Me!==null&&be.has(Me)&&(_.width!==Me.image.width||_.height!==Me.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Re.setupDepthRenderbuffer(_)}}const pe=_.texture;(pe.isData3DTexture||pe.isDataArrayTexture||pe.isCompressedArrayTexture)&&(se=!0);const Ee=be.get(_).__webglFramebuffer;_.isWebGLCubeRenderTarget?(Array.isArray(Ee[U])?L=Ee[U][D]:L=Ee[U],$=!0):_.samples>0&&Re.useMultisampledRTT(_)===!1?L=be.get(_).__webglMultisampledFramebuffer:Array.isArray(Ee)?L=Ee[D]:L=Ee,M.copy(_.viewport),C.copy(_.scissor),H=_.scissorTest}else M.copy(fe).multiplyScalar(X).floor(),C.copy(Se).multiplyScalar(X).floor(),H=Oe;if(ge.bindFramebuffer(A.FRAMEBUFFER,L)&&O&&ge.drawBuffers(_,L),ge.viewport(M),ge.scissor(C),ge.setScissorTest(H),$){const ue=be.get(_.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_CUBE_MAP_POSITIVE_X+U,ue.__webglTexture,D)}else if(se){const ue=be.get(_.texture),pe=U||0;A.framebufferTextureLayer(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,ue.__webglTexture,D||0,pe)}N=-1},this.readRenderTargetPixels=function(_,U,D,O,L,$,se){if(!(_&&_.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ue=be.get(_).__webglFramebuffer;if(_.isWebGLCubeRenderTarget&&se!==void 0&&(ue=ue[se]),ue){ge.bindFramebuffer(A.FRAMEBUFFER,ue);try{const pe=_.texture,Ee=pe.format,Me=pe.type;if(!Ge.textureFormatReadable(Ee)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ge.textureTypeReadable(Me)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=_.width-O&&D>=0&&D<=_.height-L&&A.readPixels(U,D,O,L,Ae.convert(Ee),Ae.convert(Me),$)}finally{const pe=R!==null?be.get(R).__webglFramebuffer:null;ge.bindFramebuffer(A.FRAMEBUFFER,pe)}}},this.readRenderTargetPixelsAsync=async function(_,U,D,O,L,$,se){if(!(_&&_.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ue=be.get(_).__webglFramebuffer;if(_.isWebGLCubeRenderTarget&&se!==void 0&&(ue=ue[se]),ue){ge.bindFramebuffer(A.FRAMEBUFFER,ue);try{const pe=_.texture,Ee=pe.format,Me=pe.type;if(!Ge.textureFormatReadable(Ee))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ge.textureTypeReadable(Me))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(U>=0&&U<=_.width-O&&D>=0&&D<=_.height-L){const xe=A.createBuffer();A.bindBuffer(A.PIXEL_PACK_BUFFER,xe),A.bufferData(A.PIXEL_PACK_BUFFER,$.byteLength,A.STREAM_READ),A.readPixels(U,D,O,L,Ae.convert(Ee),Ae.convert(Me),0),A.flush();const Ve=A.fenceSync(A.SYNC_GPU_COMMANDS_COMPLETE,0);await Fl(A,Ve,4);try{A.bindBuffer(A.PIXEL_PACK_BUFFER,xe),A.getBufferSubData(A.PIXEL_PACK_BUFFER,0,$)}finally{A.deleteBuffer(xe),A.deleteSync(Ve)}return $}}finally{const pe=R!==null?be.get(R).__webglFramebuffer:null;ge.bindFramebuffer(A.FRAMEBUFFER,pe)}}},this.copyFramebufferToTexture=function(_,U=null,D=0){_.isTexture!==!0&&(or("WebGLRenderer: copyFramebufferToTexture function signature has changed."),U=arguments[0]||null,_=arguments[1]);const O=Math.pow(2,-D),L=Math.floor(_.image.width*O),$=Math.floor(_.image.height*O),se=U!==null?U.x:0,ue=U!==null?U.y:0;Re.setTexture2D(_,0),A.copyTexSubImage2D(A.TEXTURE_2D,D,0,0,se,ue,L,$),ge.unbindTexture()},this.copyTextureToTexture=function(_,U,D=null,O=null,L=0){_.isTexture!==!0&&(or("WebGLRenderer: copyTextureToTexture function signature has changed."),O=arguments[0]||null,_=arguments[1],U=arguments[2],L=arguments[3]||0,D=null);let $,se,ue,pe,Ee,Me;D!==null?($=D.max.x-D.min.x,se=D.max.y-D.min.y,ue=D.min.x,pe=D.min.y):($=_.image.width,se=_.image.height,ue=0,pe=0),O!==null?(Ee=O.x,Me=O.y):(Ee=0,Me=0);const xe=Ae.convert(U.format),Ve=Ae.convert(U.type);Re.setTexture2D(U,0),A.pixelStorei(A.UNPACK_FLIP_Y_WEBGL,U.flipY),A.pixelStorei(A.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),A.pixelStorei(A.UNPACK_ALIGNMENT,U.unpackAlignment);const tt=A.getParameter(A.UNPACK_ROW_LENGTH),Je=A.getParameter(A.UNPACK_IMAGE_HEIGHT),nt=A.getParameter(A.UNPACK_SKIP_PIXELS),qe=A.getParameter(A.UNPACK_SKIP_ROWS),me=A.getParameter(A.UNPACK_SKIP_IMAGES),dt=_.isCompressedTexture?_.mipmaps[L]:_.image;A.pixelStorei(A.UNPACK_ROW_LENGTH,dt.width),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,dt.height),A.pixelStorei(A.UNPACK_SKIP_PIXELS,ue),A.pixelStorei(A.UNPACK_SKIP_ROWS,pe),_.isDataTexture?A.texSubImage2D(A.TEXTURE_2D,L,Ee,Me,$,se,xe,Ve,dt.data):_.isCompressedTexture?A.compressedTexSubImage2D(A.TEXTURE_2D,L,Ee,Me,dt.width,dt.height,xe,dt.data):A.texSubImage2D(A.TEXTURE_2D,L,Ee,Me,$,se,xe,Ve,dt),A.pixelStorei(A.UNPACK_ROW_LENGTH,tt),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,Je),A.pixelStorei(A.UNPACK_SKIP_PIXELS,nt),A.pixelStorei(A.UNPACK_SKIP_ROWS,qe),A.pixelStorei(A.UNPACK_SKIP_IMAGES,me),L===0&&U.generateMipmaps&&A.generateMipmap(A.TEXTURE_2D),ge.unbindTexture()},this.copyTextureToTexture3D=function(_,U,D=null,O=null,L=0){_.isTexture!==!0&&(or("WebGLRenderer: copyTextureToTexture3D function signature has changed."),D=arguments[0]||null,O=arguments[1]||null,_=arguments[2],U=arguments[3],L=arguments[4]||0);let $,se,ue,pe,Ee,Me,xe,Ve,tt;const Je=_.isCompressedTexture?_.mipmaps[L]:_.image;D!==null?($=D.max.x-D.min.x,se=D.max.y-D.min.y,ue=D.max.z-D.min.z,pe=D.min.x,Ee=D.min.y,Me=D.min.z):($=Je.width,se=Je.height,ue=Je.depth,pe=0,Ee=0,Me=0),O!==null?(xe=O.x,Ve=O.y,tt=O.z):(xe=0,Ve=0,tt=0);const nt=Ae.convert(U.format),qe=Ae.convert(U.type);let me;if(U.isData3DTexture)Re.setTexture3D(U,0),me=A.TEXTURE_3D;else if(U.isDataArrayTexture||U.isCompressedArrayTexture)Re.setTexture2DArray(U,0),me=A.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}A.pixelStorei(A.UNPACK_FLIP_Y_WEBGL,U.flipY),A.pixelStorei(A.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),A.pixelStorei(A.UNPACK_ALIGNMENT,U.unpackAlignment);const dt=A.getParameter(A.UNPACK_ROW_LENGTH),ui=A.getParameter(A.UNPACK_IMAGE_HEIGHT),At=A.getParameter(A.UNPACK_SKIP_PIXELS),wi=A.getParameter(A.UNPACK_SKIP_ROWS),vt=A.getParameter(A.UNPACK_SKIP_IMAGES);A.pixelStorei(A.UNPACK_ROW_LENGTH,Je.width),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,Je.height),A.pixelStorei(A.UNPACK_SKIP_PIXELS,pe),A.pixelStorei(A.UNPACK_SKIP_ROWS,Ee),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Me),_.isDataTexture||_.isData3DTexture?A.texSubImage3D(me,L,xe,Ve,tt,$,se,ue,nt,qe,Je.data):U.isCompressedArrayTexture?A.compressedTexSubImage3D(me,L,xe,Ve,tt,$,se,ue,nt,Je.data):A.texSubImage3D(me,L,xe,Ve,tt,$,se,ue,nt,qe,Je),A.pixelStorei(A.UNPACK_ROW_LENGTH,dt),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,ui),A.pixelStorei(A.UNPACK_SKIP_PIXELS,At),A.pixelStorei(A.UNPACK_SKIP_ROWS,wi),A.pixelStorei(A.UNPACK_SKIP_IMAGES,vt),L===0&&U.generateMipmaps&&A.generateMipmap(me),ge.unbindTexture()},this.initRenderTarget=function(_){be.get(_).__webglFramebuffer===void 0&&Re.setupRenderTarget(_)},this.initTexture=function(_){_.isCubeTexture?Re.setTextureCube(_,0):_.isData3DTexture?Re.setTexture3D(_,0):_.isDataArrayTexture||_.isCompressedArrayTexture?Re.setTexture2DArray(_,0):Re.setTexture2D(_,0),ge.unbindTexture()},this.resetState=function(){B=0,w=0,R=null,ge.reset(),Le.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Wt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===aa?"display-p3":"srgb",t.unpackColorSpace=ze.workingColorSpace===Lr?"display-p3":"srgb"}}class Yp extends ut{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Ft,this.environmentIntensity=1,this.environmentRotation=new Ft,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(t.object.environmentIntensity=this.environmentIntensity),t.object.environmentRotation=this.environmentRotation.toArray(),t}}class Sr extends ci{constructor(e=1,t=32,i=16,n=0,a=Math.PI*2,o=0,s=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:t,heightSegments:i,phiStart:n,phiLength:a,thetaStart:o,thetaLength:s},t=Math.max(3,Math.floor(t)),i=Math.max(2,Math.floor(i));const l=Math.min(o+s,Math.PI);let c=0;const u=[],f=new I,p=new I,m=[],v=[],x=[],d=[];for(let h=0;h<=i;h++){const T=[],y=h/i;let b=0;h===0&&o===0?b=.5/t:h===i&&l===Math.PI&&(b=-.5/t);for(let B=0;B<=t;B++){const w=B/t;f.x=-e*Math.cos(n+w*a)*Math.sin(o+y*s),f.y=e*Math.cos(o+y*s),f.z=e*Math.sin(n+w*a)*Math.sin(o+y*s),v.push(f.x,f.y,f.z),p.copy(f).normalize(),x.push(p.x,p.y,p.z),d.push(w+b,1-y),T.push(c++)}u.push(T)}for(let h=0;h<i;h++)for(let T=0;T<t;T++){const y=u[h][T+1],b=u[h][T],B=u[h+1][T],w=u[h+1][T+1];(h!==0||o>0)&&m.push(y,b,w),(h!==i-1||l<Math.PI)&&m.push(b,B,w)}this.setIndex(m),this.setAttribute("position",new Nt(v,3)),this.setAttribute("normal",new Nt(x,3)),this.setAttribute("uv",new Nt(d,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Sr(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class Kp extends fr{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new De(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new De(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=ps,this.normalScale=new Ne(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Ft,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class bo extends Kp{constructor(e){super(),this.isMeshPhysicalMaterial=!0,this.defines={STANDARD:"",PHYSICAL:""},this.type="MeshPhysicalMaterial",this.anisotropyRotation=0,this.anisotropyMap=null,this.clearcoatMap=null,this.clearcoatRoughness=0,this.clearcoatRoughnessMap=null,this.clearcoatNormalScale=new Ne(1,1),this.clearcoatNormalMap=null,this.ior=1.5,Object.defineProperty(this,"reflectivity",{get:function(){return pt(2.5*(this.ior-1)/(this.ior+1),0,1)},set:function(t){this.ior=(1+.4*t)/(1-.4*t)}}),this.iridescenceMap=null,this.iridescenceIOR=1.3,this.iridescenceThicknessRange=[100,400],this.iridescenceThicknessMap=null,this.sheenColor=new De(0),this.sheenColorMap=null,this.sheenRoughness=1,this.sheenRoughnessMap=null,this.transmissionMap=null,this.thickness=0,this.thicknessMap=null,this.attenuationDistance=1/0,this.attenuationColor=new De(1,1,1),this.specularIntensity=1,this.specularIntensityMap=null,this.specularColor=new De(1,1,1),this.specularColorMap=null,this._anisotropy=0,this._clearcoat=0,this._dispersion=0,this._iridescence=0,this._sheen=0,this._transmission=0,this.setValues(e)}get anisotropy(){return this._anisotropy}set anisotropy(e){this._anisotropy>0!=e>0&&this.version++,this._anisotropy=e}get clearcoat(){return this._clearcoat}set clearcoat(e){this._clearcoat>0!=e>0&&this.version++,this._clearcoat=e}get iridescence(){return this._iridescence}set iridescence(e){this._iridescence>0!=e>0&&this.version++,this._iridescence=e}get dispersion(){return this._dispersion}set dispersion(e){this._dispersion>0!=e>0&&this.version++,this._dispersion=e}get sheen(){return this._sheen}set sheen(e){this._sheen>0!=e>0&&this.version++,this._sheen=e}get transmission(){return this._transmission}set transmission(e){this._transmission>0!=e>0&&this.version++,this._transmission=e}copy(e){return super.copy(e),this.defines={STANDARD:"",PHYSICAL:""},this.anisotropy=e.anisotropy,this.anisotropyRotation=e.anisotropyRotation,this.anisotropyMap=e.anisotropyMap,this.clearcoat=e.clearcoat,this.clearcoatMap=e.clearcoatMap,this.clearcoatRoughness=e.clearcoatRoughness,this.clearcoatRoughnessMap=e.clearcoatRoughnessMap,this.clearcoatNormalMap=e.clearcoatNormalMap,this.clearcoatNormalScale.copy(e.clearcoatNormalScale),this.dispersion=e.dispersion,this.ior=e.ior,this.iridescence=e.iridescence,this.iridescenceMap=e.iridescenceMap,this.iridescenceIOR=e.iridescenceIOR,this.iridescenceThicknessRange=[...e.iridescenceThicknessRange],this.iridescenceThicknessMap=e.iridescenceThicknessMap,this.sheen=e.sheen,this.sheenColor.copy(e.sheenColor),this.sheenColorMap=e.sheenColorMap,this.sheenRoughness=e.sheenRoughness,this.sheenRoughnessMap=e.sheenRoughnessMap,this.transmission=e.transmission,this.transmissionMap=e.transmissionMap,this.thickness=e.thickness,this.thicknessMap=e.thicknessMap,this.attenuationDistance=e.attenuationDistance,this.attenuationColor.copy(e.attenuationColor),this.specularIntensity=e.specularIntensity,this.specularIntensityMap=e.specularIntensityMap,this.specularColor.copy(e.specularColor),this.specularColorMap=e.specularColorMap,this}}class Ao extends ut{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new De(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(t.object.target=this.target.uuid),t}}const za=new Ze,wo=new I,Ro=new I;class Co{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Ne(512,512),this.map=null,this.mapPass=null,this.matrix=new Ze,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Ca,this._frameExtents=new Ne(1,1),this._viewportCount=1,this._viewports=[new je(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,i=this.matrix;wo.setFromMatrixPosition(e.matrixWorld),t.position.copy(wo),Ro.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(Ro),t.updateMatrixWorld(),za.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(za),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(za)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}const Po=new Ze,_r=new I,Ha=new I;class Zp extends Co{constructor(){super(new St(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new Ne(4,2),this._viewportCount=6,this._viewports=[new je(2,1,1,1),new je(0,1,1,1),new je(3,1,1,1),new je(1,1,1,1),new je(3,0,1,1),new je(1,0,1,1)],this._cubeDirections=[new I(1,0,0),new I(-1,0,0),new I(0,0,1),new I(0,0,-1),new I(0,1,0),new I(0,-1,0)],this._cubeUps=[new I(0,1,0),new I(0,1,0),new I(0,1,0),new I(0,1,0),new I(0,0,1),new I(0,0,-1)]}updateMatrices(e,t=0){const i=this.camera,n=this.matrix,a=e.distance||i.far;a!==i.far&&(i.far=a,i.updateProjectionMatrix()),_r.setFromMatrixPosition(e.matrixWorld),i.position.copy(_r),Ha.copy(i.position),Ha.add(this._cubeDirections[t]),i.up.copy(this._cubeUps[t]),i.lookAt(Ha),i.updateMatrixWorld(),n.makeTranslation(-_r.x,-_r.y,-_r.z),Po.multiplyMatrices(i.projectionMatrix,i.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Po)}}class cn extends Ao{constructor(e,t,i=0,n=2){super(e,t),this.isPointLight=!0,this.type="PointLight",this.distance=i,this.decay=n,this.shadow=new Zp}get power(){return this.intensity*4*Math.PI}set power(e){this.intensity=e/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(e,t){return super.copy(e,t),this.distance=e.distance,this.decay=e.decay,this.shadow=e.shadow.clone(),this}}class Jp extends Co{constructor(){super(new Ys(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class $p extends Ao{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(ut.DEFAULT_UP),this.updateMatrix(),this.target=new ut,this.shadow=new Jp}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:xn}})),typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=xn);const Ai=new Yp;document.addEventListener("DOMContentLoaded",()=>{const r=document.getElementById("random-container"),e=document.querySelectorAll(".button"),t=(i,n)=>{const a=i.getBoundingClientRect(),o=n.getBoundingClientRect();return!(a.right<o.left||a.left>o.right||a.bottom<o.top||a.top>o.bottom)};e.forEach(i=>{if(r){let n,a,o;do{const s=r.clientWidth-i.clientWidth,l=r.clientHeight-i.clientHeight;a=Math.random()*s,o=Math.random()*l,i.style.left=`${a}px`,i.style.top=`${o}px`,n=!1,e.forEach(c=>{c!==i&&t(i,c)&&(n=!0)})}while(n)}})});function Qp(r){document.querySelectorAll(".page").forEach(t=>t.classList.remove("active"));const e=document.getElementById(r);e?e.classList.add("active"):console.error(`Page with id "${r}" not found.`)}window.showPage=Qp;const ef={1:{mainImage:"assets/1-3.png",thumbnails:["assets/1-3.png","assets/2-2.png","assets/3-1.png","assets/4-1.png","assets/9-2.png","assets/12-1.png"]},2:{mainImage:"assets/j0-1.png",thumbnails:["assets/j0.png","assets/j1.png","assets/j2.png","assets/j3.png","assets/j4.png","assets/j5.png","assets/j6.png","assets/m1.png","assets/m2.png","assets/m3.png","assets/m4.png"]},3:{mainImage:"assets/ms1.png",thumbnails:["assets/ms2.png","assets/ms3.png","assets/ms4.png","assets/ms5.png","assets/ms6.png","assets/ms7.png","assets/ms8.png","assets/ms9.png","assets/ms10.png"]},4:{mainImage:"assets/mm1.png",thumbnails:["assets/mm2.png","assets/mm3.png","assets/mm4.png","assets/mm5.png","assets/mm6.png","assets/mm7.png","assets/mm8.png"]},5:{mainImage:"assets/c1.png",thumbnails:["assets/c2.png","assets/c3.png","assets/c4.png","assets/c5.png","assets/c6.png","assets/c7.png","assets/c8.png","assets/c9.png","assets/c10.png","assets/c11.png"]},6:{mainImage:"assets/g1.png",thumbnails:["assets/g3.png","assets/g4.png","assets/g5.png","assets/g6.png","assets/g7.png","assets/g9.png","assets/g10.png","assets/g11.png","assets/g12.png","assets/g13.png","assets/g14.png","assets/g15.png","assets/g16.png","assets/g17.png","assets/g18.png","assets/g19.png","assets/g20.png"]},7:{mainImage:"assets/1.jpeg",thumbnails:["assets/2.jpeg","assets/3.jpeg","assets/4.jpeg","assets/5.jpeg","assets/7.jpeg","assets/8.jpeg","assets/9.jpeg"]}},ir=document.getElementById("myModal"),hn=document.getElementById("modal-image"),Va=document.getElementById("thumbnail-list"),Uo=document.getElementsByClassName("close")[0];window.openModal=tf;function tf(r){const e=r.getAttribute("data-id");if(e&&ir&&hn&&Va){const t=ef[e];t&&(hn.src=t.mainImage,Va.innerHTML="",t.thumbnails.forEach(i=>{const n=document.createElement("img");n.src=i,n.className="thumbnail-img",n.onclick=()=>rf(n),Va.appendChild(n)}),ir.style.display="block")}}Uo&&(Uo.onclick=function(){ir&&(ir.style.display="none")});function rf(r){hn&&(hn.src=r.src)}window.onclick=function(r){r.target===ir&&(ir.style.display="none")},document.addEventListener("DOMContentLoaded",()=>{const r=document.querySelectorAll("section"),e=document.querySelectorAll("nav ul li a"),t={threshold:.7},i=new IntersectionObserver(n=>{n.forEach(a=>{if(a.isIntersecting){const o=a.target.id;e.forEach(s=>{var l;s.classList.remove("active"),((l=s.getAttribute("href"))==null?void 0:l.substring(1))===o&&s.classList.add("active")})}})},t);r.forEach(n=>{i.observe(n)})}),Ai.background=new De(262915);const un=new St(75,window.innerWidth/window.innerHeight,.1,1e3);un.position.z=2;const dn=new qp;dn.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(dn.domElement);const nf={color:65280,labelsVisible:!1,lightColor:16777198},Lo=new $p(nf.lightColor,.3);Lo.position.set(10,15,5),Ai.add(Lo);let vr,xr,Io,pn;const af=new Sr(.5,16,8);vr=new cn(4944117,300),Ai.add(vr),xr=new cn(16719950,800),Ai.add(xr),Io=new cn(8454016,400),Io.add(new bt(af,new ba({color:8454016}))),pn=new cn(16755200,400);const sf=new Sr(4,32,32),of=new bo({color:302836,metalness:.9,roughness:.5}),Do=new bt(sf,of);Do.position.set(0,1,-4),Ai.add(Do);const lf=new Sr(.7,50,50),cf=new bo({color:5944063,metalness:.9,roughness:.5}),ka=new bt(lf,cf);Ai.add(ka),window.addEventListener("resize",hf,!1);function hf(){un.aspect=window.innerWidth/window.innerHeight,un.updateProjectionMatrix(),dn.setSize(window.innerWidth,window.innerHeight),Oo()}function No(){requestAnimationFrame(No);const r=Date.now()*5e-4;vr.position.x=Math.sin(r*.7)*30,vr.position.y=Math.cos(r*.5)*40,vr.position.z=Math.cos(r*.3)*30,xr.position.x=Math.cos(r*.3)*30,xr.position.y=Math.sin(r*.5)*40,xr.position.z=Math.sin(r*.7)*30,pn.position.x=Math.sin(r*.3)*30,pn.position.y=Math.cos(r*.7)*40,pn.position.z=Math.sin(r*.5)*30,ka.rotation.x+=.001,ka.rotation.y+=.001,Oo()}function Oo(){dn.render(Ai,un)}No();
